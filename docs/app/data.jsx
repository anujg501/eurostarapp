...
const GRADES_BY_CATEGORY = {
  ...
  multisapphire: [
    ...
    { id: 'labcreated', name: 'Lab Created Sapphires', tier: 'Premium', origin: 'Lab Grown',
      desc: 'Lab-created sapphire strips — consistent colour, sold by the strip, can be certified by IGI as "Lab Grown"',
    ...
    { id: 'aa', name: 'Synthetic Multi Sapphires', tier: 'Commercial', origin: 'Multi Strips',
      desc: 'Combination of Zirconia & synthetic Corrundums',
