...
// No demo/seed orders — the CRM shows only real orders from the local database
// (hydrated by the api-bridge). If nothing is hydrated yet the list is simply
// empty instead of showing fake rows.
const CRM_ORDERS = [];
