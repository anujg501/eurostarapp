...
const SHAPES = [
  ...
  { id: 'long-hexa', name: 'Long Hexagon', note: 'Elongated six-sided' },
  { id: 'tarpozid', name: 'Trapezoid', note: 'Four-sided taper' },
  { id: 'kite', name: 'Kite', note: 'Kite / lozenge' },
];
...
const GRADES_BY_CATEGORY = {
  ...
  multisapphire: [
    ...
    { id: 'labcreated', name: 'Lab Sapphire', tier: 'Premium', origin: 'Lab Grown',
      desc: 'Lab-grown sapphire strips — consistent colour, sold by the strip, can be certified by IGI as "Lab Grown". Each strip is approximately 7 inches long (all shapes & sizes).',
      tone: 'royal-blue', basePrice: 300, unit: 'strip', fromText: 'from ₹300', fromUnit: 'strip' },
    { id: 'aa', name: 'Synthetic Multi Sapphires', tier: 'Commercial', origin: 'Multi Strips',
      desc: 'Combination of Zirconia & synthetic Corrundums. Each strip is approximately 7 inches long (all shapes & sizes).',
      tone: 'royal-blue', basePrice: 210, unit: 'strip', fromText: 'from ₹210', fromUnit: 'strip' },
    { id: 'icecut', name: 'Ice Cut Multi Sapphires', tier: 'Ice Cut', origin: 'Lab Grown',
      desc: 'Crushed ice cutting on multi sapphire strips — maximum brilliance, sold by the strip. Each strip is approximately 7 inches long (all shapes & sizes).',
  ...
  polki: [
    ...
    { id: 'samosa', name: 'Moissanite Polki', tier: '925 Silver · Double Foiled', origin: 'Regular & Uneven', desc: 'Uneven polki, double-foiled in 92.5% silver · price shown includes foiling · ordered by packet',
      tone: 'def-white', basePrice: 60, unit: 'pc',
      subGrades: [
        { id: 'regular', name: 'Regular Shape', desc: 'Oval, pear, round & assorted shapes' },
        { id: 'b',   name: 'B Series',   desc: 'B-series · ordered by packet · priced per piece', directSize: true },
  ...
  bracelet: [
    ...
    { id: 'matrix',        name: 'Matrix',         tier: 'Fashion', desc: 'Matrix link bracelet',
      tone: 'def-white', basePrice: 750, unit: 'pc' },
    { id: 'obsidian',      name: 'Obsidian',       tier: 'Fashion', desc: 'Obsidian bead bracelet',
      tone: 'def-white', basePrice: 500, unit: 'pc' },
    { id: 'omega',         name: 'Omega',          tier: 'Fashion', desc: 'PU rope bracelet',
      tone: 'def-white', basePrice: 250, unit: 'pc' },
    { id: 'alpha',         name: 'Alpha',          tier: 'Fashion', desc: 'Steel rope bracelet',
      tone: 'def-white', basePrice: 250, unit: 'pc' },
    { id: 'designer-rakhi', name: 'Designer Rakhi', tier: 'Fashion', desc: 'Double-lock designer rakhi',
      tone: 'def-white', basePrice: 200, unit: 'pc' },
    { id: 'magnetic-halo', name: 'Magnetic Halo',  tier: 'Fashion', desc: 'Magnetic-clasp halo bracelet',
      tone: 'def-white', basePrice: 750, unit: 'pc' },
    { id: 'crimson',       name: 'Crimson',        tier: 'Fashion', desc: 'PU flat band bracelet',
      tone: 'def-white', basePrice: 500, unit: 'pc' },
    { id: 'gents-heavy',   name: 'Gents Heavy',    tier: 'Fashion', desc: 'Braided gents heavy bracelet',
      tone: 'def-white', basePrice: 750, unit: 'pc' },
  ],
  hollowmop: [
...
const SHAPES_BY_CATEGORY = {
  ...
  multisapphire: ['round','princess','oval','pear','octagon-step','octagon-princess','radiant','baguette','marquise','trillion','heart'],
...
const PREDRILLED_STONES = [
  ...
  ['11', 'Half Round',    '5.0'],
  ['12', 'Baguette',      '4 × 8'],
  ['13', 'Long Hexagon',  '7 × 3.5'],
  ['14', 'Half Round',    '5.7 × 5.9'],
  ['15', 'Flower',        '5.0'],
  ['16', 'Kite',          '7.5 × 4'],
  ['17', 'Pear',          '4.5 × 8'],
  ['18', 'Half Hex',      '5 × 2.5'],
...
const POLKI_SERIES_DESIGNS = {
  b: [
    { id: 'b-4-r', name: 'B-4 R', dims: [4,6.3], price: 4, wt: 0.11, pcsPerPacket: 1000 },
    { id: 'b-4-l', name: 'B-4 L', dims: [4,6.3], price: 4, wt: 0.113, pcsPerPacket: 1000 },
    { id: 'b-5-r', name: 'B-5 R', dims: [3.7,6.5], price: 3.6, wt: 0.106, pcsPerPacket: 1000 },
    { id: 'b-5-l', name: 'B-5 L', dims: [3.7,6.5], price: 3.6, wt: 0.104, pcsPerPacket: 1000 },
    { id: 'b-6-r', name: 'B-6 R', dims: [3.5,6.2], price: 3.6, wt: 0.089, pcsPerPacket: 1000 },
    { id: 'b-6-l', name: 'B-6 L', dims: [3.5,6.2], price: 3.6, wt: 0.087, pcsPerPacket: 1000 },
  ],
  c: [
    { id: 'c-2', name: 'C-2', dims: [5,7], price: 4.8, wt: 0.166, pcsPerPacket: 1000 },
    { id: 'c-3-r', name: 'C-3 R', dims: [7,7], price: 6, wt: 0.201, pcsPerPacket: 1000 },
    { id: 'c-3-l', name: 'C-3 L', dims: [7,7], price: 6, wt: 0.205, pcsPerPacket: 1000 },
    { id: 'c-4', name: 'C-4', dims: [5.4,6.9], price: 5.2, wt: 0.174, pcsPerPacket: 1000 },
    { id: 'c-5-r', name: 'C-5 R', dims: [5,6], price: 5, wt: 0.132, pcsPerPacket: 1000 },
    { id: 'c-5-l', name: 'C-5 L', dims: [5,6], price: 5, wt: 0.132, pcsPerPacket: 1000 },
    { id: 'c-7-r', name: 'C-7 R', dims: [5.6,6.4], price: 5.2, wt: 0.162, pcsPerPacket: 1000 },
    { id: 'c-7-l', name: 'C-7 L', dims: [5.6,6.4], price: 5.2, wt: 0.158, pcsPerPacket: 1000 },
    { id: 'c-8', name: 'C-8', dims: [6.3,7.4], price: 5.6, wt: 0.207, pcsPerPacket: 1000 },
    { id: 'c-9-r', name: 'C-9 R', dims: [4,6.5], price: 4, wt: 0.113, pcsPerPacket: 1000 },
    { id: 'c-9-l', name: 'C-9 L', dims: [4,6.5], price: 4, wt: 0.12, pcsPerPacket: 1000 },
  ],
  x: [
    { id: 'x-1', name: 'X-1', dims: [3.2,4.2], price: 2.4, wt: 0.046, pcsPerPacket: 1000 },
    { id: 'x-2', name: 'X-2', dims: [3.5,3.8], price: 2.4, wt: 0.052, pcsPerPacket: 1000 },
    { id: 'x-3-l', name: 'X-3 L', dims: [3,3.8], price: 2.4, wt: 0.04, pcsPerPacket: 1000 },
    { id: 'x-4', name: 'X-4', dims: [3,3.4], price: 2.4, wt: 0.046, pcsPerPacket: 1000 },
    { id: 'x-5', name: 'X-5', dims: [3.6,4], price: 2.4, wt: 0.063, pcsPerPacket: 1000 },
    { id: 'x-6-r', name: 'X-6 R', dims: [3,4], price: 2.4, wt: 0.05, pcsPerPacket: 1000 },
    { id: 'x-6-l', name: 'X-6 L', dims: [3,4], price: 2.4, wt: 0.047, pcsPerPacket: 1000 },
    { id: 'x-7', name: 'X-7', dims: [2,3.6,3.7], price: 2.4, wt: 0.056, pcsPerPacket: 1000 },
    { id: 'x-8', name: 'X-8', dims: [3,3.2], price: 2.4, wt: 0.033, pcsPerPacket: 1000 },
    { id: 'x-9', name: 'X-9', dims: [3.2,3.6], price: 2.4, wt: 0.05, pcsPerPacket: 1000 },
    { id: 'x-9-323', name: 'X-9', dims: [3.2,3.6], price: 2.4, wt: 0.05, pcsPerPacket: 1000 },
    { id: 'x-10', name: 'X-10', dims: [2.8,4.2], price: 2.4, wt: 0.054, pcsPerPacket: 1000 },
    { id: 'x-12', name: 'X-12', dims: [2.8,3.8], price: 2.4, wt: 0.041, pcsPerPacket: 1000 },
    { id: 'x-13', name: 'X-13', dims: [3.7,3.8], price: 2.4, wt: 0.038, pcsPerPacket: 1000 },
    { id: 'x-15', name: 'X-15', dims: [3.3,4.3], price: 2.4, wt: 0.055, pcsPerPacket: 1000 },
    { id: 'x-16', name: 'X-16', dims: [3.9,3.9], price: 2.4, wt: 0.051, pcsPerPacket: 1000 },
    { id: 'x-17-r', name: 'X-17 R', dims: [3.3,3.7], price: 2.4, wt: 0.04, pcsPerPacket: 1000 },
    { id: 'x-17-l', name: 'X-17 L', dims: [3.3,3.7], price: 2.4, wt: 0.041, pcsPerPacket: 1000 },
    { id: 'x-18', name: 'X-18', dims: [3.6,4.2], price: 2.4, wt: 0.063, pcsPerPacket: 1000 },
    { id: 'x-19', name: 'X-19', dims: [3.6,3.8], price: 2.4, wt: 0.059, pcsPerPacket: 1000 },
    { id: 'x-20', name: 'X-20', dims: [3,3.5], price: 2.4, wt: 0.043, pcsPerPacket: 1000 },
    { id: 'x-21-r', name: 'X-21 R', dims: [3.3,4.3], price: 2.4, wt: 0.047, pcsPerPacket: 1000 },
    { id: 'x-21-l', name: 'X-21 L', dims: [3.3,4.3], price: 2.4, wt: 0.046, pcsPerPacket: 1000 },
    { id: 'x-22-r', name: 'X-22 R', dims: [3.6,3.9], price: 2.4, wt: 0.064, pcsPerPacket: 1000 },
    { id: 'x-22-l', name: 'X-22 L', dims: [3.6,3.9], price: 2.4, wt: 0.056, pcsPerPacket: 1000 },
    { id: 'x-23', name: 'X-23', dims: [3.8,3.8], price: 2.4, wt: 0.059, pcsPerPacket: 1000 },
  ],
  z: [
    { id: 'z-1-r', name: 'Z-1 R', dims: [9,10], price: 12, wt: 0.418, pcsPerPacket: 1000 },
    { id: 'z-2-l', name: 'Z-2 L', dims: [9,10], price: 12, wt: 0.429, pcsPerPacket: 1000 },
    { id: 'z-3-r', name: 'Z-3 R', dims: [5.9,9.2], price: 6.8, wt: 0.237, pcsPerPacket: 1000 },
    { id: 'z-3-l', name: 'Z-3 L', dims: [5.9,9.2], price: 6.8, wt: 0.24, pcsPerPacket: 1000 },
    { id: 'z-4', name: 'Z-4', dims: [7.7,10.7], price: 7.2, wt: 0.373, pcsPerPacket: 1000 },
    { id: 'z-5-r', name: 'Z-5 R', dims: [7.3,8.1], price: 7.2, wt: 0.298, pcsPerPacket: 1000 },
    { id: 'z-5-l', name: 'Z-5 L', dims: [7.3,8.1], price: 7.2, wt: 0.301, pcsPerPacket: 1000 },
    { id: 'z-6-r', name: 'Z-6 R', dims: [7.2,9.3], price: 9.6, wt: 0.319, pcsPerPacket: 1000 },
    { id: 'z-7-r', name: 'Z-7 R', dims: [6.2,7.2], price: 6, wt: 0.188, pcsPerPacket: 1000 },
    { id: 'z-9', name: 'Z-9', dims: [5.4,8.4], price: 6.4, wt: 0.203, pcsPerPacket: 1000 },
    { id: 'z-10', name: 'Z-10', dims: [7.3,7.7], price: 7.2, wt: 0.253, pcsPerPacket: 1000 },
    { id: 'z-14', name: 'Z-14', dims: [6.5,8], price: 7.4, wt: 0.234, pcsPerPacket: 1000 },
    { id: 'z-15-r', name: 'Z-15 R', dims: [4.9,9.9], price: 6.8, wt: 0.207, pcsPerPacket: 1000 },
    { id: 'z-15', name: 'Z-15', dims: [4.9], price: 6.8, wt: 0.223, pcsPerPacket: 1000 },
    { id: 'z-17-r', name: 'Z-17 R', dims: [7.4,8], price: 7.2, wt: 0.261, pcsPerPacket: 1000 },
    { id: 'z-17-l', name: 'Z-17 L', dims: [7.4,8], price: 7.2, wt: 0.272, pcsPerPacket: 1000 },
    { id: 'z-19-r', name: 'Z-19 R', dims: [6,7], price: 6, wt: 0.175, pcsPerPacket: 1000 },
    { id: 'z-20-r', name: 'Z-20 R', dims: [6.8,8.5], price: 7.6, wt: 0.237, pcsPerPacket: 1000 },
    { id: 'z-20-l', name: 'Z-20 L', dims: [6.8,8.5], price: 7.6, wt: 0.248, pcsPerPacket: 1000 },
    { id: 'z-21', name: 'Z-21', dims: [4.7,8.6], price: 6.4, wt: 0.176, pcsPerPacket: 1000 },
    { id: 'z-22', name: 'Z-22', dims: [7.1,8.1], price: 7.2, wt: 0.262, pcsPerPacket: 1000 },
    { id: 'z-25', name: 'Z-25', dims: [5.5,10.5], price: 7.2, wt: 0.264, pcsPerPacket: 1000 },
    { id: 'z-26', name: 'Z-26', dims: [6.3,8.3], price: 7, wt: 0.239, pcsPerPacket: 1000 },
    { id: 'z-27-r', name: 'Z-27 R', dims: [6.7,10.7], price: 10, wt: 0.32, pcsPerPacket: 1000 },
    { id: 'z-27-l', name: 'Z-27 L', dims: [6.7,10.7], price: 10, wt: 0.328, pcsPerPacket: 1000 },
  ],
  pcj: [
    { id: 'pcj-3', name: 'PCJ-3', dims: [4.5,6.8], price: 3.6, wt: 0.136, pcsPerPacket: 1000 },
    { id: 'pcj-4', name: 'PCJ-4', dims: [6,8.5], price: 5.2, wt: 0.21, pcsPerPacket: 1000 },
    { id: 'pcj-5', name: 'PCJ-5', dims: [6.5,9], price: 5.6, wt: 0.253, pcsPerPacket: 1000 },
    { id: 'pcj-6', name: 'PCJ-6', dims: [8,11], price: 8.4, wt: 0.46, pcsPerPacket: 1000 },
    { id: 'pcj-7', name: 'PCJ-7', dims: [9,13], price: 15, wt: 0.625, pcsPerPacket: 1000 },
    { id: 'pcj-8', name: 'PCJ-8', dims: [8,12], price: 12, wt: 0.509, pcsPerPacket: 1000 },
  ],
  gj: [
    { id: 'gj-1', name: 'GJ-1', dims: [2.5,4.4], price: 2.4, wt: 0.0043, pcsPerPacket: 1000 },
    { id: 'gj-2-r', name: 'GJ-2 R', dims: [2.9,5], price: 3, wt: 0.0057, pcsPerPacket: 1000 },
    { id: 'gj-2-l', name: 'GJ-2 L', dims: [2.9,5], price: 3, wt: 0.0055, pcsPerPacket: 1000 },
    { id: 'gj-3-r', name: 'GJ-3 R', dims: [2.9,5.8], price: 3.2, wt: 0.0062, pcsPerPacket: 1000 },
    { id: 'gj-3-l', name: 'GJ-3 L', dims: [2.9,5.8], price: 3.2, wt: 0.0066, pcsPerPacket: 1000 },
    { id: 'gj-4', name: 'GJ-4', dims: [2,3,3.5], price: 1.9, wt: 0.0052, pcsPerPacket: 1000 },
    { id: 'gj-5', name: 'GJ-5', dims: [2.5,4,4], price: 2.2, wt: 0.0066, pcsPerPacket: 1000 },
    { id: 'gj-6', name: 'GJ-6', dims: [2.6,5.2], price: 3, wt: 0.0053, pcsPerPacket: 1000 },
    { id: 'gj-7', name: 'GJ-7', dims: [2,3,3], price: 1.9, wt: 0.0039, pcsPerPacket: 1000 },
    { id: 'gj-8-r', name: 'GJ-8 R', dims: [2.5,3.2], price: 2.2, wt: 0.0031, pcsPerPacket: 1000 },
    { id: 'gj-8-l', name: 'GJ-8 L', dims: [2.5,3.2], price: 2.2, wt: 0.0032, pcsPerPacket: 1000 },
    { id: 'gj-9', name: 'GJ-9', dims: [2,4.5,5], price: 3.2, wt: 0.0082, pcsPerPacket: 1000 },
    { id: 'gj-10', name: 'GJ-10', dims: [2.5,3], price: 2.2, wt: 0.0028, pcsPerPacket: 1000 },
    { id: 'gj-11', name: 'GJ-11', dims: [3,4,5], price: 3.2, wt: 0.009, pcsPerPacket: 1000 },
    { id: 'gj-12', name: 'GJ-12', dims: [3.5,4.4], price: 3.2, wt: 0.0058, pcsPerPacket: 1000 },
    { id: 'gj-13', name: 'GJ-13', dims: [3.5,4.5], price: 3.2, wt: 0.006, pcsPerPacket: 1000 },
    { id: 'gj-14', name: 'GJ-14', dims: [3.5,3.5], price: 2.6, wt: 0.0035, pcsPerPacket: 1000 },
    { id: 'gj-15', name: 'GJ-15', dims: [3.6,5], price: 4.6, wt: 0.0065, pcsPerPacket: 1000 },
    { id: 'gj-16-r', name: 'GJ-16 R', dims: [3,6.7], price: 3, wt: 0.008, pcsPerPacket: 1000 },
    { id: 'gj-16-l', name: 'GJ-16 L', dims: [3,6.7], price: 3, wt: 0.0089, pcsPerPacket: 1000 },
    { id: 'gj-17', name: 'GJ-17', dims: [3.6,5.7], price: 3.2, wt: 0.0083, pcsPerPacket: 1000 },
    { id: 'gj-18', name: 'GJ-18', dims: [3.5,6], price: 3.2, wt: 0.0075, pcsPerPacket: 1000 },
    { id: 'gj-19', name: 'GJ-19', dims: [3.5,4], price: 2, wt: 0.005, pcsPerPacket: 1000 },
    { id: 'gj-20', name: 'GJ-20', dims: [4,4], price: 2.2, wt: 0.0073, pcsPerPacket: 1000 },
    { id: 'gj-21', name: 'GJ-21', dims: [4,6.4], price: 4, wt: 0.0085, pcsPerPacket: 1000 },
    { id: 'gj-22', name: 'GJ-22', dims: [4,4.3], price: 3.2, wt: 0.0065, pcsPerPacket: 1000 },
    { id: 'gj-23', name: 'GJ-23', dims: [4,5.2], price: 3.6, wt: 0.0083, pcsPerPacket: 1000 },
    { id: 'gj-24', name: 'GJ-24', dims: [4,5], price: 4.4, wt: 0.0082, pcsPerPacket: 1000 },
    { id: 'gj-25', name: 'GJ-25', dims: [4,4.6], price: 3.2, wt: 0.0073, pcsPerPacket: 1000 },
    { id: 'gj-26', name: 'GJ-26', dims: [4,6.5], price: 3.6, wt: 0.0098, pcsPerPacket: 1000 },
    { id: 'gj-27', name: 'GJ-27', dims: [5,6], price: 4.4, wt: 0.009, pcsPerPacket: 1000 },
    { id: 'gj-28', name: 'GJ-28', dims: [4,4], price: 5, wt: 0.0088, pcsPerPacket: 1000 },
    { id: 'gj-29', name: 'GJ-29', dims: [4.5,8.5], price: 6, wt: 0.0159, pcsPerPacket: 1000 },
    { id: 'gj-30-l', name: 'GJ-30 L', dims: [4.5,5.4], price: 4, wt: 0.0099, pcsPerPacket: 1000 },
    { id: 'gj-31-r', name: 'GJ-31 R', dims: [4.4,4.7], price: 4, wt: 0.0066, pcsPerPacket: 1000 },
    { id: 'gj-31-l', name: 'GJ-31 L', dims: [4.4,4.7], price: 4, wt: 0.0065, pcsPerPacket: 1000 },
    { id: 'gj-32-r', name: 'GJ-32 R', dims: [4,6], price: 4, wt: 0.0082, pcsPerPacket: 1000 },
    { id: 'gj-32-l', name: 'GJ-32 L', dims: [4,6], price: 4, wt: 0.0079, pcsPerPacket: 1000 },
    { id: 'gj-33-r', name: 'GJ-33 R', dims: [4,8], price: 3.6, wt: 0.0112, pcsPerPacket: 1000 },
    { id: 'gj-33-l', name: 'GJ-33 L', dims: [4,8], price: 3.6, wt: 0.0106, pcsPerPacket: 1000 },
    { id: 'gj-34-r', name: 'GJ-34 R', dims: [4.5,7.3], price: 6, wt: 0.0122, pcsPerPacket: 1000 },
    { id: 'gj-34-l', name: 'GJ-34 L', dims: [4.5,7.3], price: 6, wt: 0.0119, pcsPerPacket: 1000 },
    { id: 'gj-35-r', name: 'GJ-35 R', dims: [4,7], price: 6, wt: 0.0125, pcsPerPacket: 1000 },
    { id: 'gj-35-l', name: 'GJ-35 L', dims: [4,7], price: 6, wt: 0.0123, pcsPerPacket: 1000 },
    { id: 'gj-36', name: 'GJ-36', dims: [5,5], price: 3.2, wt: 0.0115, pcsPerPacket: 1000 },
    { id: 'gj-37', name: 'GJ-37', dims: [5,4,3], price: 3, wt: 0.0095, pcsPerPacket: 1000 },
    { id: 'gj-38', name: 'GJ-38', dims: [5.2,7.6], price: 4.6, wt: 0.0146, pcsPerPacket: 1000 },
    { id: 'gj-39', name: 'GJ-39', dims: [5,5], price: 4, wt: 0.0114, pcsPerPacket: 1000 },
    { id: 'gj-40', name: 'GJ-40', dims: [5.4,7], price: 4.2, wt: 0.14, pcsPerPacket: 1000 },
    { id: 'gj-41', name: 'GJ-41', dims: [5,8], price: 5, wt: 0.177, pcsPerPacket: 1000 },
    { id: 'gj-42', name: 'GJ-42', dims: [5,7.5], price: 4.4, wt: 0.127, pcsPerPacket: 1000 },
    { id: 'gj-43', name: 'GJ-43', dims: [5,5.5], price: 4, wt: 0.114, pcsPerPacket: 1000 },
    { id: 'gj-44', name: 'GJ-44', dims: [5,7], price: 4, wt: 0.126, pcsPerPacket: 1000 },
    { id: 'gj-45', name: 'GJ-45', dims: [5,6], price: 4.4, wt: 0.104, pcsPerPacket: 1000 },
    { id: 'gj-46-r', name: 'GJ-46 R', dims: [5,7], price: 4.4, wt: 0.148, pcsPerPacket: 1000 },
    { id: 'gj-47', name: 'GJ-47', dims: [5,7], price: 6, wt: 0.128, pcsPerPacket: 1000 },
    { id: 'gj-48', name: 'GJ-48', dims: [5,5], price: 4.8, wt: 0.104, pcsPerPacket: 1000 },
    { id: 'gj-49-r', name: 'GJ-49 R', dims: [5.4,6.7], price: 4.8, wt: 0.138, pcsPerPacket: 1000 },
    { id: 'gj-49-l', name: 'GJ-49 L', dims: [5.4,6.7], price: 4.8, wt: 0.142, pcsPerPacket: 1000 },
    { id: 'gj-50-r', name: 'GJ-50 R', dims: [5.5,6.5], price: 4.8, wt: 0.135, pcsPerPacket: 1000 },
    { id: 'gj-50-l', name: 'GJ-50 L', dims: [5.5,6.5], price: 4.8, wt: 0.14, pcsPerPacket: 1000 },
    { id: 'gj-51-r', name: 'GJ-51 R', dims: [5.4,6.6], price: 4.8, wt: 0.155, pcsPerPacket: 1000 },
    { id: 'gj-51-l', name: 'GJ-51 L', dims: [5.4,6.6], price: 6, wt: 0.154, pcsPerPacket: 1000 },
    { id: 'gj-52-r', name: 'GJ-52 R', dims: [5.4,7.5], price: 6, wt: 0.145, pcsPerPacket: 1000 },
    { id: 'gj-52-l', name: 'GJ-52 L', dims: [5.4,7.5], price: 6, wt: 0.141, pcsPerPacket: 1000 },
    { id: 'gj-53-r', name: 'GJ-53 R', dims: [5.3,5.7], price: 6, wt: 0.13, pcsPerPacket: 1000 },
    { id: 'gj-53-l', name: 'GJ-53 L', dims: [5.3,5.7], price: 6, wt: 0.136, pcsPerPacket: 1000 },
    { id: 'gj-54-r', name: 'GJ-54 R', dims: [5,9], price: 6.6, wt: 0.191, pcsPerPacket: 1000 },
    { id: 'gj-54-l', name: 'GJ-54 L', dims: [5,9], price: 6.6, wt: 0.184, pcsPerPacket: 1000 },
    { id: 'gj-55-r', name: 'GJ-55 R', dims: [5,7.3], price: 6.6, wt: 0.131, pcsPerPacket: 1000 },
    { id: 'gj-55-l', name: 'GJ-55 L', dims: [5,7.3], price: 6.6, wt: 0.134, pcsPerPacket: 1000 },
    { id: 'gj-56-r', name: 'GJ-56 R', dims: [5.8,7], price: 7, wt: 0.146, pcsPerPacket: 1000 },
    { id: 'gj-56-l', name: 'GJ-56 L', dims: [5.8,7], price: 7, wt: 0.14, pcsPerPacket: 1000 },
    { id: 'gj-57-r', name: 'GJ-57 R', dims: [5.7,6.5], price: 4.8, wt: 0.129, pcsPerPacket: 1000 },
    { id: 'gj-57-l', name: 'GJ-57 L', dims: [5.7,6.5], price: 4.8, wt: 0.128, pcsPerPacket: 1000 },
    { id: 'gj-58', name: 'GJ-58', dims: [6,7], price: 6, wt: 0.136, pcsPerPacket: 1000 },
    { id: 'gj-59', name: 'GJ-59', dims: [6,7.3], price: 6.4, wt: 0.185, pcsPerPacket: 1000 },
    { id: 'gj-60', name: 'GJ-60', dims: [6.5,7.5], price: 6, wt: 0.165, pcsPerPacket: 1000 },
    { id: 'gj-61', name: 'GJ-61', dims: [6,8.5], price: 5.2, wt: 0.172, pcsPerPacket: 1000 },
    { id: 'gj-62-l', name: 'GJ-62 L', dims: [6.5,11], price: 11.6, wt: 0.278, pcsPerPacket: 1000 },
    { id: 'gj-63', name: 'GJ-63', dims: [6,8.5], price: 6, wt: 0.234, pcsPerPacket: 1000 },
    { id: 'gj-64-l', name: 'GJ-64 L', dims: [6,7], price: 6, wt: 0.193, pcsPerPacket: 1000 },
    { id: 'gj-65', name: 'GJ-65', dims: [6,6], price: 5.6, wt: 0.146, pcsPerPacket: 1000 },
    { id: 'gj-66', name: 'GJ-66', dims: [6,6], price: 5.6, wt: 0.169, pcsPerPacket: 1000 },
    { id: 'gj-67-r', name: 'GJ-67 R', dims: [6.3,6.6], price: 5.2, wt: 0.131, pcsPerPacket: 1000 },
    { id: 'gj-67-l', name: 'GJ-67 L', dims: [6.3,6.6], price: 5.2, wt: 0.131, pcsPerPacket: 1000 },
    { id: 'gj-68-r', name: 'GJ-68 R', dims: [6.5,10], price: 11, wt: 0.26, pcsPerPacket: 1000 },
    { id: 'gj-68-l', name: 'GJ-68 L', dims: [6.5,10], price: 11, wt: 0.245, pcsPerPacket: 1000 },
    { id: 'gj-69-l', name: 'GJ-69 L', dims: [7,8], price: 7.6, wt: 0.253, pcsPerPacket: 1000 },
    { id: 'gj-70-r', name: 'GJ-70 R', dims: [8,11.5], price: 15, wt: 0.436, pcsPerPacket: 1000 },
    { id: 'gj-70-l', name: 'GJ-70 L', dims: [8,11.5], price: 15.6, wt: 0.433, pcsPerPacket: 1000 },
    { id: 'gj-71', name: 'GJ-71', dims: [9,14.5], price: 24, wt: 0.519, pcsPerPacket: 1000 },
    { id: 'gj-72-r', name: 'GJ-72 R', dims: [9,11], price: 19, wt: 0.508, pcsPerPacket: 1000 },
    { id: 'gj-72-l', name: 'GJ-72 L', dims: [9,11], price: 19, wt: 0.519, pcsPerPacket: 1000 },
    { id: 'gj-73-r', name: 'GJ-73 R', dims: [9.3,11], price: 19, wt: 0.495, pcsPerPacket: 1000 },
    { id: 'gj-73-l', name: 'GJ-73 L', dims: [9.3,11], price: 19, wt: 0.487, pcsPerPacket: 1000 },
    { id: 'gj-74-r', name: 'GJ-74 R', dims: [10,11], price: 24, wt: 0.465, pcsPerPacket: 1000 },
    { id: 'gj-74-l', name: 'GJ-74 L', dims: [10,11], price: 24, wt: 4.64, pcsPerPacket: 1000 },
    { id: 'gj-75-r', name: 'GJ-75 R', dims: [9.7,10.3], price: 15.6, wt: 0.456, pcsPerPacket: 1000 },
    { id: 'gj-75-l', name: 'GJ-75 L', dims: [9.7,10.3], price: 15.6, wt: 0.465, pcsPerPacket: 1000 },
    { id: 'gj-76-r', name: 'GJ-76 R', dims: [9.7,10], price: 15.6, wt: 0.427, pcsPerPacket: 1000 },
    { id: 'gj-76-l', name: 'GJ-76 L', dims: [9.7,10], price: 15.6, wt: 0.422, pcsPerPacket: 1000 },
    { id: 'gj-77-r', name: 'GJ-77 R', dims: [9.5,11], price: 16, wt: 0.498, pcsPerPacket: 1000 },
    { id: 'gj-77-l', name: 'GJ-77 L', dims: [9.5,11], price: 16, wt: 0.5, pcsPerPacket: 1000 },
    { id: 'gj-78-r', name: 'GJ-78 R', dims: [4.7,5.3], price: 5.6, wt: 0.119, pcsPerPacket: 1000 },
    { id: 'gj-78-l', name: 'GJ-78 L', dims: [4.7,5.3], price: 5.6, wt: 0.105, pcsPerPacket: 1000 },
  ],
};

// Moissanite (gold-foil) Uneven Polki — same designs, WITH-FOIL all-in price.
const POLKI_SAMOSA_DESIGNS = {
  b: [
    { id: 'b-4-r', name: 'B-4 R', dims: [4,6.3], price: 28, wt: 0.11, pcsPerPacket: 100 },
    { id: 'b-4-l', name: 'B-4 L', dims: [4,6.3], price: 28, wt: 0.113, pcsPerPacket: 100 },
    { id: 'b-5-r', name: 'B-5 R', dims: [3.7,6.5], price: 28, wt: 0.106, pcsPerPacket: 100 },
    { id: 'b-5-l', name: 'B-5 L', dims: [3.7,6.5], price: 28, wt: 0.104, pcsPerPacket: 100 },
    { id: 'b-6-r', name: 'B-6 R', dims: [3.5,6.2], price: 28, wt: 0.089, pcsPerPacket: 100 },
    { id: 'b-6-l', name: 'B-6 L', dims: [3.5,6.2], price: 28, wt: 0.087, pcsPerPacket: 100 },
  ],
  c: [
    { id: 'c-2', name: 'C-2', dims: [5,7], price: 28, wt: 0.166, pcsPerPacket: 100 },
    { id: 'c-3-r', name: 'C-3 R', dims: [7,7], price: 30, wt: 0.201, pcsPerPacket: 100 },
    { id: 'c-3-l', name: 'C-3 L', dims: [7,7], price: 30, wt: 0.205, pcsPerPacket: 100 },
    { id: 'c-4', name: 'C-4', dims: [5.4,6.9], price: 28, wt: 0.174, pcsPerPacket: 100 },
    { id: 'c-5-r', name: 'C-5 R', dims: [5,6], price: 28, wt: 0.132, pcsPerPacket: 100 },
    { id: 'c-5-l', name: 'C-5 L', dims: [5,6], price: 28, wt: 0.132, pcsPerPacket: 100 },
    { id: 'c-7-r', name: 'C-7 R', dims: [5.6,6.4], price: 28, wt: 0.162, pcsPerPacket: 100 },
    { id: 'c-7-l', name: 'C-7 L', dims: [5.6,6.4], price: 28, wt: 0.158, pcsPerPacket: 100 },
    { id: 'c-8', name: 'C-8', dims: [6.3,7.4], price: 30, wt: 0.207, pcsPerPacket: 100 },
    { id: 'c-9-r', name: 'C-9 R', dims: [4,6.5], price: 28, wt: 0.113, pcsPerPacket: 100 },
    { id: 'c-9-l', name: 'C-9 L', dims: [4,6.5], price: 28, wt: 0.12, pcsPerPacket: 100 },
  ],
  x: [
    { id: 'x-1', name: 'X-1', dims: [3.2,4.2], price: 25, wt: 0.046, pcsPerPacket: 100 },
    { id: 'x-2', name: 'X-2', dims: [3.5,3.8], price: 25, wt: 0.052, pcsPerPacket: 100 },
    { id: 'x-3-l', name: 'X-3 L', dims: [3,3.8], price: 25, wt: 0.04, pcsPerPacket: 100 },
    { id: 'x-4', name: 'X-4', dims: [3,3.4], price: 25, wt: 0.046, pcsPerPacket: 100 },
    { id: 'x-5', name: 'X-5', dims: [3.6,4], price: 25, wt: 0.063, pcsPerPacket: 100 },
    { id: 'x-6-r', name: 'X-6 R', dims: [3,4], price: 25, wt: 0.05, pcsPerPacket: 100 },
    { id: 'x-6-l', name: 'X-6 L', dims: [3,4], price: 25, wt: 0.047, pcsPerPacket: 100 },
    { id: 'x-7', name: 'X-7', dims: [2,3.6,3.7], price: 25, wt: 0.056, pcsPerPacket: 100 },
    { id: 'x-8', name: 'X-8', dims: [3,3.2], price: 25, wt: 0.033, pcsPerPacket: 100 },
    { id: 'x-9', name: 'X-9', dims: [3.2,3.6], price: 25, wt: 0.05, pcsPerPacket: 100 },
    { id: 'x-9-323', name: 'X-9', dims: [3.2,3.6], price: 25, wt: null, pcsPerPacket: 100 },
    { id: 'x-10', name: 'X-10', dims: [2.8,4.2], price: 25, wt: 0.054, pcsPerPacket: 100 },
    { id: 'x-12', name: 'X-12', dims: [2.8,3.8], price: 25, wt: 0.041, pcsPerPacket: 100 },
    { id: 'x-13', name: 'X-13', dims: [3.7,3.8], price: 25, wt: 0.038, pcsPerPacket: 100 },
    { id: 'x-15', name: 'X-15', dims: [3.3,4.3], price: 25, wt: 0.055, pcsPerPacket: 100 },
    { id: 'x-16', name: 'X-16', dims: [3.9,3.9], price: 25, wt: 0.051, pcsPerPacket: 100 },
    { id: 'x-17-r', name: 'X-17 R', dims: [3.3,3.7], price: 25, wt: 0.04, pcsPerPacket: 100 },
    { id: 'x-17-l', name: 'X-17 L', dims: [3.3,3.7], price: 25, wt: 0.041, pcsPerPacket: 100 },
    { id: 'x-18', name: 'X-18', dims: [3.6,4.2], price: 25, wt: 0.063, pcsPerPacket: 100 },
    { id: 'x-19', name: 'X-19', dims: [3.6,3.8], price: 25, wt: 0.059, pcsPerPacket: 100 },
    { id: 'x-20', name: 'X-20', dims: [3,3.5], price: 25, wt: 0.043, pcsPerPacket: 100 },
    { id: 'x-21-r', name: 'X-21 R', dims: [3.3,4.3], price: 25, wt: 0.047, pcsPerPacket: 100 },
    { id: 'x-21-l', name: 'X-21 L', dims: [3.3,4.3], price: 25, wt: 0.046, pcsPerPacket: 100 },
    { id: 'x-22-r', name: 'X-22 R', dims: [3.6,3.9], price: 25, wt: 0.064, pcsPerPacket: 100 },
    { id: 'x-22-l', name: 'X-22 L', dims: [3.6,3.9], price: 25, wt: 0.056, pcsPerPacket: 100 },
    { id: 'x-23', name: 'X-23', dims: [3.8,3.8], price: 25, wt: 0.059, pcsPerPacket: 100 },
  ],
  z: [
    { id: 'z-1-r', name: 'Z-1 R', dims: [9,10], price: 40, wt: 0.418, pcsPerPacket: 100 },
    { id: 'z-2-l', name: 'Z-2 L', dims: [9,10], price: 40, wt: 0.429, pcsPerPacket: 100 },
    { id: 'z-3-r', name: 'Z-3 R', dims: [5.9,9.2], price: 35, wt: 0.237, pcsPerPacket: 100 },
    { id: 'z-3-l', name: 'Z-3 L', dims: [5.9,9.2], price: 35, wt: 0.24, pcsPerPacket: 100 },
    { id: 'z-4', name: 'Z-4', dims: [7.7,10.7], price: 35, wt: 0.373, pcsPerPacket: 100 },
    { id: 'z-5-r', name: 'Z-5 R', dims: [7.3,8.1], price: 35, wt: 0.298, pcsPerPacket: 100 },
    { id: 'z-5-l', name: 'Z-5 L', dims: [7.3,8.1], price: 35, wt: 0.301, pcsPerPacket: 100 },
    { id: 'z-6-r', name: 'Z-6 R', dims: [7.2,9.3], price: 40, wt: 0.319, pcsPerPacket: 100 },
    { id: 'z-7-r', name: 'Z-7 R', dims: [6.2,7.2], price: 35, wt: 0.188, pcsPerPacket: 100 },
    { id: 'z-9', name: 'Z-9', dims: [5.4,8.4], price: 35, wt: 0.203, pcsPerPacket: 100 },
    { id: 'z-10', name: 'Z-10', dims: [7.3,7.7], price: 35, wt: 0.253, pcsPerPacket: 100 },
    { id: 'z-14', name: 'Z-14', dims: [6.5,8], price: 35, wt: 0.234, pcsPerPacket: 100 },
    { id: 'z-15-r', name: 'Z-15 R', dims: [4.9,9.9], price: 35, wt: 0.207, pcsPerPacket: 100 },
    { id: 'z-15', name: 'Z-15', dims: [4.9], price: 35, wt: 0.223, pcsPerPacket: 100 },
    { id: 'z-17-r', name: 'Z-17 R', dims: [7.4,8], price: 35, wt: 0.261, pcsPerPacket: 100 },
    { id: 'z-17-l', name: 'Z-17 L', dims: [7.4,8], price: 35, wt: 0.272, pcsPerPacket: 100 },
    { id: 'z-19-r', name: 'Z-19 R', dims: [6,7], price: 35, wt: 0.175, pcsPerPacket: 100 },
    { id: 'z-20-r', name: 'Z-20 R', dims: [6.8,8.5], price: 35, wt: 0.237, pcsPerPacket: 100 },
    { id: 'z-20-l', name: 'Z-20 L', dims: [6.8,8.5], price: 35, wt: 0.248, pcsPerPacket: 100 },
    { id: 'z-21', name: 'Z-21', dims: [4.7,8.6], price: 35, wt: 0.176, pcsPerPacket: 100 },
    { id: 'z-22', name: 'Z-22', dims: [7.1,8.1], price: 35, wt: 0.262, pcsPerPacket: 100 },
    { id: 'z-25', name: 'Z-25', dims: [5.5,10.5], price: 35, wt: 0.264, pcsPerPacket: 100 },
    { id: 'z-26', name: 'Z-26', dims: [6.3,8.3], price: 35, wt: 0.239, pcsPerPacket: 100 },
    { id: 'z-27-r', name: 'Z-27 R', dims: [6.7,10.7], price: 40, wt: 0.32, pcsPerPacket: 100 },
    { id: 'z-27-l', name: 'Z-27 L', dims: [6.7,10.7], price: 40, wt: 0.328, pcsPerPacket: 100 },
  ],
  pcj: [
    { id: 'pcj-3', name: 'PCJ-3', dims: [4.5,6.8], price: 30, wt: 0.136, pcsPerPacket: 100 },
    { id: 'pcj-4', name: 'PCJ-4', dims: [6,8.5], price: 35, wt: 0.21, pcsPerPacket: 100 },
    { id: 'pcj-5', name: 'PCJ-5', dims: [6.5,9], price: 35, wt: 0.253, pcsPerPacket: 100 },
    { id: 'pcj-6', name: 'PCJ-6', dims: [8,11], price: 40, wt: 0.46, pcsPerPacket: 100 },
    { id: 'pcj-7', name: 'PCJ-7', dims: [9,13], price: 45, wt: 0.625, pcsPerPacket: 100 },
    { id: 'pcj-8', name: 'PCJ-8', dims: [8,12], price: 40, wt: 0.509, pcsPerPacket: 100 },
  ],
  gj: [
    { id: 'gj-1', name: 'GJ-1', dims: [2.5,4.4], price: 25, wt: 0.0043, pcsPerPacket: 100 },
    { id: 'gj-2-r', name: 'GJ-2 R', dims: [2.9,5], price: 25, wt: 0.0057, pcsPerPacket: 100 },
    { id: 'gj-2-l', name: 'GJ-2 L', dims: [2.9,5], price: 25, wt: 0.0055, pcsPerPacket: 100 },
    { id: 'gj-3-r', name: 'GJ-3 R', dims: [2.9,5.8], price: 28, wt: 0.0062, pcsPerPacket: 100 },
    { id: 'gj-3-l', name: 'GJ-3 L', dims: [2.9,5.8], price: 28, wt: 0.0066, pcsPerPacket: 100 },
    { id: 'gj-4', name: 'GJ-4', dims: [2,3,3.5], price: 25, wt: 0.0052, pcsPerPacket: 100 },
    { id: 'gj-5', name: 'GJ-5', dims: [2.5,4,4], price: 25, wt: 0.0066, pcsPerPacket: 100 },
    { id: 'gj-6', name: 'GJ-6', dims: [2.6,5.2], price: 25, wt: 0.0053, pcsPerPacket: 100 },
    { id: 'gj-7', name: 'GJ-7', dims: [2,3,3], price: 25, wt: 0.0039, pcsPerPacket: 100 },
    { id: 'gj-8-r', name: 'GJ-8 R', dims: [2.5,3.2], price: 25, wt: 0.0031, pcsPerPacket: 100 },
    { id: 'gj-8-l', name: 'GJ-8 L', dims: [2.5,3.2], price: 25, wt: 0.0032, pcsPerPacket: 100 },
    { id: 'gj-9', name: 'GJ-9', dims: [2,4.5,5], price: 28, wt: 0.0082, pcsPerPacket: 100 },
    { id: 'gj-10', name: 'GJ-10', dims: [2.5,3], price: 25, wt: 0.0028, pcsPerPacket: 100 },
    { id: 'gj-11', name: 'GJ-11', dims: [3,4,5], price: 28, wt: 0.009, pcsPerPacket: 100 },
    { id: 'gj-12', name: 'GJ-12', dims: [3.5,4.4], price: 28, wt: 0.0058, pcsPerPacket: 100 },
    { id: 'gj-13', name: 'GJ-13', dims: [3.5,4.5], price: 28, wt: 0.006, pcsPerPacket: 100 },
    { id: 'gj-14', name: 'GJ-14', dims: [3.5,3.5], price: 25, wt: 0.0035, pcsPerPacket: 100 },
    { id: 'gj-15', name: 'GJ-15', dims: [3.6,5], price: 28, wt: 0.0065, pcsPerPacket: 100 },
    { id: 'gj-16-r', name: 'GJ-16 R', dims: [3,6.7], price: 25, wt: 0.008, pcsPerPacket: 100 },
    { id: 'gj-16-l', name: 'GJ-16 L', dims: [3,6.7], price: 25, wt: 0.0089, pcsPerPacket: 100 },
    { id: 'gj-17', name: 'GJ-17', dims: [3.6,5.7], price: 28, wt: 0.0083, pcsPerPacket: 100 },
    { id: 'gj-18', name: 'GJ-18', dims: [3.5,6], price: 28, wt: 0.0075, pcsPerPacket: 100 },
    { id: 'gj-19', name: 'GJ-19', dims: [3.5,4], price: 25, wt: 0.005, pcsPerPacket: 100 },
    { id: 'gj-20', name: 'GJ-20', dims: [4,4], price: 25, wt: 0.0073, pcsPerPacket: 100 },
    { id: 'gj-21', name: 'GJ-21', dims: [4,6.4], price: 28, wt: 0.0085, pcsPerPacket: 100 },
    { id: 'gj-22', name: 'GJ-22', dims: [4,4.3], price: 28, wt: 0.0065, pcsPerPacket: 100 },
    { id: 'gj-23', name: 'GJ-23', dims: [4,5.2], price: 28, wt: 0.0083, pcsPerPacket: 100 },
    { id: 'gj-24', name: 'GJ-24', dims: [4,5], price: 28, wt: 0.0082, pcsPerPacket: 100 },
    { id: 'gj-25', name: 'GJ-25', dims: [4,4.6], price: 28, wt: 0.0073, pcsPerPacket: 100 },
    { id: 'gj-26', name: 'GJ-26', dims: [4,6.5], price: 28, wt: 0.0098, pcsPerPacket: 100 },
    { id: 'gj-27', name: 'GJ-27', dims: [5,6], price: 28, wt: 0.009, pcsPerPacket: 100 },
    { id: 'gj-28', name: 'GJ-28', dims: [4,4], price: 28, wt: 0.0088, pcsPerPacket: 100 },
    { id: 'gj-29', name: 'GJ-29', dims: [4.5,8.5], price: 30, wt: 0.0159, pcsPerPacket: 100 },
    { id: 'gj-30-l', name: 'GJ-30 L', dims: [4.5,5.4], price: 28, wt: 0.0099, pcsPerPacket: 100 },
    { id: 'gj-31-r', name: 'GJ-31 R', dims: [4.4,4.7], price: 28, wt: 0.0066, pcsPerPacket: 100 },
    { id: 'gj-31-l', name: 'GJ-31 L', dims: [4.4,4.7], price: 28, wt: 0.0065, pcsPerPacket: 100 },
    { id: 'gj-32-r', name: 'GJ-32 R', dims: [4,6], price: 28, wt: 0.0082, pcsPerPacket: 100 },
    { id: 'gj-32-l', name: 'GJ-32 L', dims: [4,6], price: 28, wt: 0.0079, pcsPerPacket: 100 },
    { id: 'gj-33-r', name: 'GJ-33 R', dims: [4,8], price: 28, wt: 0.0112, pcsPerPacket: 100 },
    { id: 'gj-33-l', name: 'GJ-33 L', dims: [4,8], price: 28, wt: 0.0106, pcsPerPacket: 100 },
    { id: 'gj-34-r', name: 'GJ-34 R', dims: [4.5,7.3], price: 30, wt: 0.0122, pcsPerPacket: 100 },
    { id: 'gj-34-l', name: 'GJ-34 L', dims: [4.5,7.3], price: 30, wt: 0.0119, pcsPerPacket: 100 },
    { id: 'gj-35-r', name: 'GJ-35 R', dims: [4,7], price: 30, wt: 0.0125, pcsPerPacket: 100 },
    { id: 'gj-35-l', name: 'GJ-35 L', dims: [4,7], price: 30, wt: 0.0123, pcsPerPacket: 100 },
    { id: 'gj-36', name: 'GJ-36', dims: [5,5], price: 30, wt: 0.0115, pcsPerPacket: 100 },
    { id: 'gj-37', name: 'GJ-37', dims: [5,4,3], price: 25, wt: 0.0095, pcsPerPacket: 100 },
    { id: 'gj-38', name: 'GJ-38', dims: [5.2,7.6], price: 28, wt: 0.0146, pcsPerPacket: 100 },
    { id: 'gj-39', name: 'GJ-39', dims: [5,5], price: 28, wt: 0.0114, pcsPerPacket: 100 },
    { id: 'gj-40', name: 'GJ-40', dims: [5.4,7], price: 28, wt: 0.14, pcsPerPacket: 100 },
    { id: 'gj-41', name: 'GJ-41', dims: [5,8], price: 30, wt: 0.177, pcsPerPacket: 100 },
    { id: 'gj-42', name: 'GJ-42', dims: [5,7.5], price: 30, wt: 0.127, pcsPerPacket: 100 },
    { id: 'gj-43', name: 'GJ-43', dims: [5,5.5], price: 30, wt: 0.114, pcsPerPacket: 100 },
    { id: 'gj-44', name: 'GJ-44', dims: [5,7], price: 30, wt: 0.126, pcsPerPacket: 100 },
    { id: 'gj-45', name: 'GJ-45', dims: [5,6], price: 30, wt: 0.104, pcsPerPacket: 100 },
    { id: 'gj-46-r', name: 'GJ-46 R', dims: [5,7], price: 30, wt: 0.148, pcsPerPacket: 100 },
    { id: 'gj-47', name: 'GJ-47', dims: [5,7], price: 30, wt: 0.128, pcsPerPacket: 100 },
    { id: 'gj-48', name: 'GJ-48', dims: [5,5], price: 30, wt: 0.104, pcsPerPacket: 100 },
    { id: 'gj-49-r', name: 'GJ-49 R', dims: [5.4,6.7], price: 30, wt: 0.138, pcsPerPacket: 100 },
    { id: 'gj-49-l', name: 'GJ-49 L', dims: [5.4,6.7], price: 30, wt: 0.142, pcsPerPacket: 100 },
    { id: 'gj-50-r', name: 'GJ-50 R', dims: [5.5,6.5], price: 30, wt: 0.135, pcsPerPacket: 100 },
    { id: 'gj-50-l', name: 'GJ-50 L', dims: [5.5,6.5], price: 30, wt: 0.14, pcsPerPacket: 100 },
    { id: 'gj-51-r', name: 'GJ-51 R', dims: [5.4,6.6], price: 30, wt: 0.155, pcsPerPacket: 100 },
    { id: 'gj-51-l', name: 'GJ-51 L', dims: [5.4,6.6], price: 30, wt: 0.154, pcsPerPacket: 100 },
    { id: 'gj-52-r', name: 'GJ-52 R', dims: [5.4,7.5], price: 30, wt: 0.145, pcsPerPacket: 100 },
    { id: 'gj-52-l', name: 'GJ-52 L', dims: [5.4,7.5], price: 30, wt: 0.141, pcsPerPacket: 100 },
    { id: 'gj-53-r', name: 'GJ-53 R', dims: [5.3,5.7], price: 30, wt: 0.13, pcsPerPacket: 100 },
    { id: 'gj-53-l', name: 'GJ-53 L', dims: [5.3,5.7], price: 30, wt: 0.136, pcsPerPacket: 100 },
    { id: 'gj-54-r', name: 'GJ-54 R', dims: [5,9], price: 35, wt: 0.191, pcsPerPacket: 100 },
    { id: 'gj-54-l', name: 'GJ-54 L', dims: [5,9], price: 35, wt: 0.184, pcsPerPacket: 100 },
    { id: 'gj-55-r', name: 'GJ-55 R', dims: [5,7.3], price: 30, wt: 0.131, pcsPerPacket: 100 },
    { id: 'gj-55-l', name: 'GJ-55 L', dims: [5,7.3], price: 30, wt: 0.134, pcsPerPacket: 100 },
    { id: 'gj-56-r', name: 'GJ-56 R', dims: [5.8,7], price: 35, wt: 0.146, pcsPerPacket: 100 },
    { id: 'gj-56-l', name: 'GJ-56 L', dims: [5.8,7], price: 35, wt: 0.14, pcsPerPacket: 100 },
    { id: 'gj-57-r', name: 'GJ-57 R', dims: [5.7,6.5], price: 30, wt: 0.129, pcsPerPacket: 100 },
    { id: 'gj-57-l', name: 'GJ-57 L', dims: [5.7,6.5], price: 30, wt: 0.128, pcsPerPacket: 100 },
    { id: 'gj-58', name: 'GJ-58', dims: [6,7], price: 30, wt: 0.136, pcsPerPacket: 100 },
    { id: 'gj-59', name: 'GJ-59', dims: [6,7.3], price: 30, wt: 0.185, pcsPerPacket: 100 },
    { id: 'gj-60', name: 'GJ-60', dims: [6.5,7.5], price: 30, wt: 0.165, pcsPerPacket: 100 },
    { id: 'gj-61', name: 'GJ-61', dims: [6,8.5], price: 35, wt: 0.172, pcsPerPacket: 100 },
    { id: 'gj-62-l', name: 'GJ-62 L', dims: [6.5,11], price: 40, wt: 0.278, pcsPerPacket: 100 },
    { id: 'gj-63', name: 'GJ-63', dims: [6,8.5], price: 35, wt: 0.234, pcsPerPacket: 100 },
    { id: 'gj-64-l', name: 'GJ-64 L', dims: [6,7], price: 30, wt: 0.193, pcsPerPacket: 100 },
    { id: 'gj-65', name: 'GJ-65', dims: [6,6], price: 30, wt: 0.146, pcsPerPacket: 100 },
    { id: 'gj-66', name: 'GJ-66', dims: [6,6], price: 30, wt: 0.169, pcsPerPacket: 100 },
    { id: 'gj-67-r', name: 'GJ-67 R', dims: [6.3,6.6], price: 30, wt: 0.131, pcsPerPacket: 100 },
    { id: 'gj-67-l', name: 'GJ-67 L', dims: [6.3,6.6], price: 30, wt: 0.131, pcsPerPacket: 100 },
    { id: 'gj-68-r', name: 'GJ-68 R', dims: [6.5,10], price: 40, wt: 0.26, pcsPerPacket: 100 },
    { id: 'gj-68-l', name: 'GJ-68 L', dims: [6.5,10], price: 40, wt: 0.245, pcsPerPacket: 100 },
    { id: 'gj-69-l', name: 'GJ-69 L', dims: [7,8], price: 35, wt: 0.253, pcsPerPacket: 100 },
    { id: 'gj-70-r', name: 'GJ-70 R', dims: [8,11.5], price: 45, wt: 0.436, pcsPerPacket: 100 },
    { id: 'gj-70-l', name: 'GJ-70 L', dims: [8,11.5], price: 45, wt: 0.433, pcsPerPacket: 100 },
    { id: 'gj-71', name: 'GJ-71', dims: [9,14.5], price: 60, wt: 0.519, pcsPerPacket: 100 },
    { id: 'gj-72-r', name: 'GJ-72 R', dims: [9,11], price: 50, wt: 0.508, pcsPerPacket: 100 },
    { id: 'gj-72-l', name: 'GJ-72 L', dims: [9,11], price: 50, wt: 0.519, pcsPerPacket: 100 },
    { id: 'gj-73-r', name: 'GJ-73 R', dims: [9.3,11], price: 50, wt: 0.495, pcsPerPacket: 100 },
    { id: 'gj-73-l', name: 'GJ-73 L', dims: [9.3,11], price: 50, wt: 0.487, pcsPerPacket: 100 },
    { id: 'gj-74-r', name: 'GJ-74 R', dims: [10,11], price: 60, wt: 0.465, pcsPerPacket: 100 },
    { id: 'gj-74-l', name: 'GJ-74 L', dims: [10,11], price: 60, wt: 4.64, pcsPerPacket: 100 },
    { id: 'gj-75-r', name: 'GJ-75 R', dims: [9.7,10.3], price: 45, wt: 0.456, pcsPerPacket: 100 },
    { id: 'gj-75-l', name: 'GJ-75 L', dims: [9.7,10.3], price: 45, wt: 0.465, pcsPerPacket: 100 },
    { id: 'gj-76-r', name: 'GJ-76 R', dims: [9.7,10], price: 45, wt: 0.427, pcsPerPacket: 100 },
    { id: 'gj-76-l', name: 'GJ-76 L', dims: [9.7,10], price: 45, wt: 0.422, pcsPerPacket: 100 },
    { id: 'gj-77-r', name: 'GJ-77 R', dims: [9.5,11], price: 50, wt: 0.498, pcsPerPacket: 100 },
    { id: 'gj-77-l', name: 'GJ-77 L', dims: [9.5,11], price: 50, wt: 0.5, pcsPerPacket: 100 },
    { id: 'gj-78-r', name: 'GJ-78 R', dims: [4.7,5.3], price: 30, wt: 0.119, pcsPerPacket: 100 },
    { id: 'gj-78-l', name: 'GJ-78 L', dims: [4.7,5.3], price: 30, wt: 0.105, pcsPerPacket: 100 },
  ],
};
...
// Multi Sapphire strip sheets. Row = [size, INR/line, pcs/line, approx ct, inches].
// Natural (aaa) is CARAT-priced: 'approx ct' holds carats per 7" strip and price = ct x grade INR/ct.
// Other grades carry a direct INR/line price.
const MULTISAPPHIRE_SHEETS = {
  'aaa': {
    'round': [['1.50 mm',2530,119,2.32,null],['1.80 mm',1320,98,3.05,null],['2.00 mm',1320,85,3.45,null],['2.25 mm',1320,78,5.1,null],['2.50 mm',1320,72,5.9,null],['2.75 mm',1485,64,6.5,null],['3.00 mm',2310,60,7.74,null]],
    'princess': [['1.50 mm',5060,105,2.8,null],['1.80 mm',2530,90,3.7,null],['2.00 mm',2310,84,5.16,null],['2.25 mm',1760,76,5.84,null],['2.50 mm',2090,72,7.79,null],['2.75 mm',2200,66,9,null],['3.00 mm',2750,60,11.4,null],['4.00 mm',8910,46,18.8,null]],
    'oval': [['3×4 mm',1320,44,8.4,null],['3×5 mm',1595,36,8.72,null],['4×5 mm',2310,36,14.35,null],['4×6 mm',3190,30,15.5,null],['5×7 mm',6875,25,24.1,null]],
    'pear': [['3×4 mm',1320,44,8.4,null],['3×5 mm',1595,36,8.72,null],['4×5 mm',2310,36,14.35,null],['4×6 mm',3190,30,15.5,null],['5×7 mm',6875,25,24.1,null]],
    'octagon-step': [['3×4 mm',2310,53,15.04,null],['3×5 mm',3685,36,12.75,null],['4×5 mm',5500,36,18.91,null],['4×6 mm',7810,30,19.7,null]],
    'marquise': [['2×4 mm',1870,46,4.65,null],['2.5×5 mm',2090,36,6.41,null],['3×6 mm',2530,28,8.41,null]],
    'baguette': [['1.5×3 mm',3410,58,3.66,null],['2×3 mm',1760,58,5.96,null],['2×3.5 mm',1980,50,6.58,null],['2×4 mm',2420,45,6.31,null],['2.5×5 mm',3465,36,8.55,null]],
    'trillion': [['3.00 mm',2530,60,6.5,null],['3.50 mm',3410,52,8.2,null],['4.00 mm',2970,46,11,null]],
    'heart': [['3.00 mm',2530,60,6.5,null],['3.50 mm',3410,52,8.2,null],['4.00 mm',2970,46,11,null]],
  },
  'labcreated': {
...
const msCarats = (gradeId, shape, size) => { const r = msRow(gradeId, shape, size); return r ? r[3] : null; };
const msPcs = (gradeId, shape, size) => { const r = msRow(gradeId, shape, size); return r ? r[2] : null; };
const msShapes = (gradeId) => { const g = MULTISAPPHIRE_SHEETS[gradeId]; return g ? Object.keys(g) : []; };
window.msSizes = msSizes; window.msRow = msRow; window.msRate = msRate; window.msCarats = msCarats; window.msPcs = msPcs; window.msShapes = msShapes;
...
const MOISS_CHART = {
  ...
  'square': [['3×3 mm',0.15],['3.5×3.5 mm',0.24],['4×4 mm',0.36],['4.5×4.5 mm',0.51],['5×5 mm',0.64],['5.5×5.5 mm',0.9],['6×6 mm',1.2],['6.5×6.5 mm',1.54],['7×7 mm',1.89],['7.5×7.5 mm',2.36],['8×8 mm',2.61],['8.5×8.5 mm',3.47],['9×9 mm',3.86],['10×10 mm',6.26],['11×11 mm',8.26]],
...
// ---- Lab Grown Corundum: flat Rs150/ct x moissanite weight, all colours, per piece ----
const LABCORUNDUM_CT = 150;
const LABCORUNDUM_SHAPES = ['round','square','asscher','cushion','oval','pear','octagon-step','marquise'];
const LABCORUNDUM_TARGET = {
  'round': ['5.00 mm','5.50 mm','6.00 mm','6.50 mm','7.00 mm','7.50 mm','8.00 mm','8.50 mm','9.00 mm','10.00 mm','11.00 mm','12.00 mm','13.00 mm','14.00 mm'],
  'square': ['5×5 mm','5.5×5.5 mm','6×6 mm','6.5×6.5 mm','7×7 mm','7.5×7.5 mm','8×8 mm','8.5×8.5 mm','9×9 mm','10×10 mm','11×11 mm'],
  'asscher': ['5×5 mm','5.5×5.5 mm','6×6 mm','6.5×6.5 mm','7×7 mm','7.5×7.5 mm','8×8 mm','8.5×8.5 mm','9×9 mm','10×10 mm','11×11 mm'],
  'cushion': ['5×5 mm','5.5×5.5 mm','6×6 mm','6.5×6.5 mm','7×7 mm','7.5×7.5 mm','8×8 mm','9×9 mm','10×10 mm','11×11 mm'],
  'oval': ['4×6 mm','5×7 mm','6×8 mm','7×9 mm','8×10 mm','10×14 mm'],
  'pear': ['4×6 mm','5×7 mm','6×8 mm','7×9 mm','8×10 mm','10×12 mm','10×14 mm'],
  'octagon-step': ['4×6 mm','5×7 mm','6×8 mm','7×9 mm','8×10 mm','10×12 mm','10×14 mm'],
  'marquise': ['3×6 mm','4×8 mm','5×10 mm','6×12 mm','7×14 mm'],
};
function lgCorSizes(shape) { return LABCORUNDUM_TARGET[shape] ? LABCORUNDUM_TARGET[shape].slice() : []; }
...
const CORUNDUM_SHEETS = {
  'aaa|ruby5': {
    round: [
      ['0.80 mm',1000,0.98],['0.90 mm',1000,0.84],['1.00 mm',1000,0.84],['1.10 mm',1000,0.84],['1.20 mm',1000,0.98],
      ['1.30 mm',1000,1.12],['1.40 mm',1000,1.26],['1.50 mm',1000,1.4],['1.60 mm',1000,1.6],['1.70 mm',1000,1.74],
      ['1.80 mm',1000,1.9],['1.90 mm',1000,2.24],['2.00 mm',1000,2.24],['2.10 mm',500,3.22],['2.20 mm',500,3.92],
      ['2.30 mm',500,4.2],['2.40 mm',500,4.76],['2.50 mm',500,4.9],['2.60 mm',500,5.88],['2.70 mm',500,6.44],
      ['2.80 mm',500,7.56],['2.90 mm',500,8.12],['3.00 mm',500,8.12],['3.25 mm',200,9.8],['3.50 mm',200,11.2],
      ['3.75 mm',200,12.04],['4.00 mm',200,13.44],['4.25 mm',200,15.4],['4.50 mm',200,16.24],['4.75 mm',200,21.0],
      ['5.00 mm',100,23.24],['5.25 mm',100,28.0],['5.50 mm',100,30.8],['5.75 mm',100,32.2],['6.00 mm',100,33.6],
      ['6.50 mm',100,43.4],['7.00 mm',100,50.4],['7.50 mm',100,58.8],['8.00 mm',50,70.0],
    ],
    oval: [
      ['3×2 mm',500,13.48],['3×2.5 mm',500,13.57],['4×3 mm',500,13.48],['4.5×3.5 mm',500,24.42],['5×3 mm',200,16.07],
      ['5×4 mm',200,24.42],['6×4 mm',200,24.42],['7×5 mm',100,34.27],['8×5 mm',100,48.44],['8×6 mm',100,48.44],
      ['9×7 mm',50,52.5],['10×8 mm',50,58.8],
    ],
    pear: [
      ['3×2 mm',500,13.48],['3×2.5 mm',500,13.57],['4×3 mm',500,13.48],['4.5×3.5 mm',500,24.42],['5×3 mm',200,16.07],
      ['5×4 mm',200,24.42],['6×4 mm',200,24.42],['7×5 mm',100,34.27],['8×5 mm',100,48.44],['8×6 mm',100,48.44],
    ...
    marquise: [
      ['3×1.5 mm',500,8.67],['4×2 mm',500,9.81],['5×2.5 mm',200,13.92],['6×3 mm',200,18.77],['7×3.5 mm',200,21.84],
      ['8×4 mm',100,26.22],['9×4.5 mm',100,52.96],
    ],
    princess: [
      ['1.5 mm',1000,8.39],['1.75 mm',1000,7.0],['2 mm',1000,6.93],['2.25 mm',500,7.5],['2.5 mm',500,9.24],
      ['2.75 mm',500,9.45],['3 mm',500,10.12],['3.25 mm',200,17.51],['3.5 mm',200,18.76],['4 mm',200,19.33],
      ['5 mm',100,34.31],['6 mm',100,41.31],['9 mm',50,162.4],
    ],
    'octagon-princess': [
      ['5×3 mm',200,10.12],['6×4 mm',200,20.17],['7×5 mm',100,33.26],['8×6 mm',100,53.37],['10×8 mm',50,131.6],
      ['11×9 mm',25,189.0],
    ],
    heart: [
      ['3 mm',200,10.12],['4 mm',200,21.01],['5 mm',100,27.78],
    ],
  },
  'aaa|blue34': {
  ...
  'aa|ruby8': {
    'baguette': [['1.1×0.8 mm',1000,5.94],['1.2×0.8 mm',1000,5.94],['1.3×0.8 mm',1000,5.94],['1.4×0.8 mm',1000,5.94],['1.5×0.8 mm',1000,5.94],['1.5×1 mm',1000,5.06],['1.6×0.8 mm',1000,5.94],['1.6×1 mm',1000,5.06],['1.7×0.8 mm',1000,5.94],['1.7×1 mm',1000,5.06],['1.8×0.8 mm',1000,5.94],['1.8×1 mm',1000,5.06],['1.8×1.5 mm',1000,5.06],['1.9×0.8 mm',1000,5.94],['1.9×1 mm',1000,5.06],['2×0.8 mm',1000,5.94],['2×1 mm',1000,4.9],['2×1.5 mm',1000,5.06],['2.1×1.2 mm',1000,6.42],['2.2×1.2 mm',1000,6.42],['2.2×1.25 mm',1000,4.84],['2.25×1.25 mm',1000,5.81],['2.3×1.2 mm',1000,6.42],['2.4×1.2 mm',1000,6.42],['2.5×1.2 mm',1000,6.42],['2.5×1.25 mm',1000,5.06],['2.5×1.5 mm',1000,5.61],['2.6×1.5 mm',1000,5.61],['2.7×1.5 mm',1000,5.61],['2.75×1.5 mm',1000,5.81],['2.8×1.5 mm',1000,5.61],['2.9×1.5 mm',1000,5.61],['3×1 mm',1000,6.42],['3×1.5 mm',1000,5.61],['3×2 mm',1000,7.27],['3.25×1.5 mm',500,8.36],['3.25×2 mm',500,9.9],['3.5×1.5 mm',500,7.27],['3.5×2 mm',500,8.36],['3.5×2.5 mm',500,12.1],['3.75×1.5 mm',500,8.36],['4×1.5 mm',500,8.36],['4×2 mm',500,7.27],['4×2.5 mm',500,13.2],['4×3 mm',500,21.39],['4.5×2 mm',500,9.9],['4.5×2.5 mm',500,12.77],['5×2.5 mm',200,13.2],['5×3 mm',200,14.3],['6×3 mm',200,22.8],['8×4 mm',200,22.8]],
    'princess': [['1.5 mm',1000,4.84],['1.75 mm',1000,5.06],['2 mm',1000,4.16],['2.25 mm',500,5.82],['2.5 mm',500,8.14],['2.75 mm',500,8.36],['3 mm',500,8.36],['3.25 mm',200,11.43],['3.5 mm',200,16.21],['4 mm',200,19.36],['4.5 mm',200,29.39],['5 mm',100,32.41],['5.5 mm',100,39.89],['6 mm',100,52.92],['7 mm',100,74.8],['8 mm',50,85.8],['9 mm',50,135.67]],
    'octagon-step': [['3×2 mm',500,9.9],['4×2 mm',500,11],['4×3 mm',500,20.78],['5×3 mm',200,24],['5×4 mm',200,38.88],['6×4 mm',100,32.27],['7×5 mm',100,51.33],['8×6 mm',100,69.67],['9×7 mm',50,110],['10×8 mm',50,143],['11×9 mm',50,209],['12×10 mm',25,201.67],['16×12 mm',25,385],['12×8 mm',25,162.56]],
    'round': [['0.70 mm',1000,1.01],['0.80 mm',1000,0.72],['0.90 mm',1000,0.56],['1.00 mm',1000,0.42],['1.10 mm',1000,0.48],['1.20 mm',1000,0.55],['1.30 mm',1000,0.66],['1.40 mm',1000,0.76],['1.50 mm',1000,0.84],['1.60 mm',1000,1],['1.70 mm',1000,1.12],['1.80 mm',1000,1.38],['1.90 mm',1000,1.54],['2.00 mm',1000,1.68],['2.10 mm',500,2.1],['2.20 mm',500,2.92],['2.30 mm',500,3],['2.40 mm',500,3.31],['2.50 mm',500,3.29],['2.60 mm',500,3.96],['2.70 mm',500,4.7],['2.80 mm',500,5.33],['2.90 mm',500,5.51],['3.00 mm',500,5.8],['3.10 mm',200,6.91],['3.25 mm',200,8.28],['3.50 mm',200,10.36],['3.75 mm',200,12.42],['4.00 mm',200,15.53],['4.25 mm',200,17.5],['4.50 mm',200,21.42],['4.75 mm',200,25.34],['5.00 mm',100,28.87],['5.25 mm',100,31.5],['5.50 mm',100,36.7],['5.75 mm',100,42],['6.00 mm',100,45.95],['6.25 mm',100,45.95],['6.50 mm',100,52.97],['6.75 mm',100,48.68],['7.00 mm',100,52.47],['7.50 mm',100,74.8],['8.00 mm',50,82.5],['9.00 mm',50,126.5],['10.00 mm',50,198]],
    'heart': [['3 mm',200,10.2],['3.5 mm',200,17.04],['4 mm',200,17.04],['5 mm',100,26.4],['6 mm',100,41.56],['7 mm',100,56.22],['8 mm',50,88],['10 mm',25,143.73]],
    'marquise': [['3×1.5 mm',500,6.34],['3×2 mm',500,7.04],['4×2 mm',500,5.82],['4.5×2.5 mm',500,15.89],['5×2.5 mm',200,9.97],['6×3 mm',200,18.36],['7×3.5 mm',200,25.97],['8×4 mm',100,33.24],['9×4.5 mm',100,72.6],['10×5 mm',50,66],['12×6 mm',25,117.33],['14×7 mm',25,156.44]],
    'cushion': [['3 mm',200,16.5],['3.5 mm',200,22],['4 mm',200,21.6],['5 mm',100,30.8],['6 mm',100,46.2],['7 mm',50,70.4],['8 mm',50,92.4],['9 mm',50,165],['10 mm',25,209]],
    'oval': [['2.5×1.5 mm',500,6.6],['3×2 mm',500,7.06],['3×2.5 mm',500,7.9],['3.5×2.5 mm',500,13.2],['4×2.5 mm',500,15.33],['4×3 mm',500,10.56],['4.5×2.5 mm',500,15.4],['5×3 mm',200,13.2],['5×4 mm',200,25.3],['6×4 mm',200,24.84],['7×5 mm',100,40.27],['8×6 mm',100,47.67],['9×5 mm',50,116.11],['9×6 mm',50,72.11],['9×7 mm',50,75.78],['10×8 mm',50,107.07],['11×6 mm',50,174.78],['11×7 mm',50,144.22],['11×9 mm',50,135.67],['12×10 mm',25,256.67],['12×5 mm',25,174.78],['12×6 mm',25,174.78],['12×8 mm',25,132],['14×10 mm',25,319],['14×9 mm',25,268.89]],
    'pear': [['2.5×1.5 mm',500,6.6],['3×2 mm',500,7.06],['3×2.5 mm',500,7.9],['3.5×2.5 mm',500,13.2],['4×2.5 mm',500,15.33],['4×3 mm',500,10.56],['4.5×2.5 mm',500,15.4],['5×3 mm',200,13.2],['5×4 mm',200,25.3],['6×4 mm',200,24.84],['7×5 mm',100,40.27],['8×6 mm',100,47.67],['9×5 mm',50,116.11],['9×6 mm',50,72.11],['9×7 mm',50,75.78],['10×8 mm',50,107.07],['11×6 mm',50,174.78],['11×7 mm',50,144.22],['11×9 mm',50,135.67],['12×10 mm',25,256.67],['12×5 mm',25,174.78],['12×6 mm',25,174.78],['12×8 mm',25,132],['14×10 mm',25,319],['14×9 mm',25,268.89]],
    'star': [['3 mm',200,11],['4 mm',200,17.6],['5 mm',100,25.52],['6 mm',100,42.24],['7 mm',50,92.4],['8 mm',50,121]],
    'octagon-princess': [['8×6 mm',100,83.11]],
    'triangle': [['3 mm',500,12.47],['4 mm',200,20.37],['5 mm',100,31.17],['6 mm',100,43.63],['7 mm',50,56.1],['8 mm',50,121],['9 mm',50,156.32],['10 mm',25,229.9]],
    'trillion': [['3 mm',200,13.2],['4 mm',200,32.08],['5 mm',100,47.06],['6 mm',100,66.31],['7 mm',50,96.25],['8 mm',50,117.64],['9 mm',50,149.72],['10 mm',25,198.92]],
    'asscher': [['3 mm',200,23.1],['4 mm',200,19.14],['5 mm',100,33],['6 mm',100,44],['7 mm',50,83.11],['8 mm',50,99],['9 mm',50,189.44]],
  },
  'aa|ruby5': {
    'round': [['0.70 mm',1000,1.05],['0.80 mm',1000,0.2],['0.90 mm',1000,0.2],['1.00 mm',1000,0.25],['1.10 mm',1000,0.25],['1.20 mm',1000,0.31],['1.30 mm',1000,0.31],['1.40 mm',1000,0.35],['1.50 mm',1000,0.4],['1.60 mm',1000,0.42],['1.70 mm',1000,0.52],['1.80 mm',1000,0.63],['1.90 mm',1000,0.67],['2.00 mm',1000,0.76],['2.10 mm',500,0.83],['2.20 mm',500,1.11],['2.25 mm',500,1.08],['2.30 mm',500,1.21],['2.40 mm',500,1.39],['2.50 mm',500,1.38],['2.60 mm',500,1.71],['2.70 mm',500,1.69],['2.75 mm',500,1.79],['2.80 mm',500,1.98],['2.90 mm',500,1.87],['3.00 mm',500,2.16],['3.10 mm',200,2.34],['3.20 mm',200,2.45],['3.25 mm',200,2.75],['3.30 mm',200,2.86],['3.40 mm',200,4.19],['3.50 mm',200,3.19],['3.60 mm',200,3.48],['3.70 mm',200,3.96],['3.75 mm',200,3.88],['3.80 mm',200,4.33],['3.90 mm',200,4.33],['4.00 mm',200,3.97],['4.25 mm',200,5.3],['4.50 mm',200,6.12],['4.75 mm',200,7.7],['5.00 mm',100,8.46],['5.25 mm',100,10.12],['5.50 mm',100,12.85],['5.75 mm',100,12.85],['6.00 mm',100,13.46],['6.25 mm',100,17.16],['6.50 mm',100,19.36],['6.75 mm',100,26.84],['7.00 mm',100,21.78],['7.25 mm',100,39.6],['7.50 mm',100,31.16],['7.75 mm',50,46.2],['8.00 mm',50,37.4],['8.25 mm',50,56.1],['8.50 mm',50,45.71],['8.75 mm',50,61.6],['9.00 mm',50,51.95],['9.50 mm',50,72.72],['10.00 mm',50,66],['10.50 mm',25,80.66],['11.00 mm',25,95.34],['11.50 mm',25,99.74],['12.00 mm',25,99.74],['13.00 mm',25,193.11],['14.00 mm',25,231],['15.00 mm',25,196.78],['16.00 mm',15,308],['18.00 mm',15,374]],
    'marquise': [['3×2 mm',500,2.7],['3×1.5 mm',500,2],['3.5×2 mm',500,4.66],['4×2 mm',500,2],['4.5×2.5 mm',500,3.67],['5×2.5 mm',200,3.08],['6×3 mm',200,4.62],['7×3.5 mm',200,8.36],['8×4 mm',100,12.1],['9×4.5 mm',100,26.4],['10×5 mm',50,26.4],['12×6 mm',25,57.2],['14×7 mm',25,72.6]],
    'baguette': [['1.1×0.8 mm',1000,2.15],['1.2×0.8 mm',1000,1.66],['1.3×0.8 mm',1000,1.66],['1.4×0.8 mm',1000,1.66],['1.5×0.8 mm',1000,1.66],['1.6×0.8 mm',1000,1.66],['1.7×0.8 mm',1000,1.66],['1.8×0.8 mm',1000,1.66],['1.9×0.8 mm',1000,2.33],['2×0.8 mm',1000,2.33],['1.5×1 mm',1000,2.33],['2×1 mm',1000,2.33],['2.5×1 mm',1000,2.33],['1.5×1.25 mm',1000,2.33],['2×1.25 mm',1000,2.33],['2.1×1.25 mm',1000,2.33],['2.25×1.25 mm',1000,2.33],['2.3×1.25 mm',1000,2.33],['2.4×1.25 mm',1000,2.33],['2.5×1.25 mm',1000,2.33],['2.6×1.25 mm',1000,2.33],['2.7×1.25 mm',1000,2.33],['2.8×1.25 mm',1000,2.33],['2.9×1.25 mm',1000,2.33],['2×1.5 mm',1000,2.33],['2.1×1.5 mm',1000,2.33],['2.25×1.5 mm',1000,2.33],['2.3×1.5 mm',1000,2.33],['2.4×1.5 mm',1000,2.33],['2.5×1.5 mm',1000,2.33],['2.6×1.5 mm',1000,2.33],['2.75×1.5 mm',1000,2.33],['2.8×1.5 mm',1000,2.33],['2.9×1.5 mm',1000,2.33],['3×1.5 mm',1000,2.33],['3.25×1.5 mm',500,2.09],['3.5×1.5 mm',500,2.33],['3.5×1.75 mm',500,2.46],['3×2 mm',1000,2.33],['3.5×2 mm',500,2.33],['3.75×2 mm',500,2.33],['4×2 mm',500,1.93],['3×2.5 mm',1000,2.76],['4×2.5 mm',500,3.96],['4.5×2.5 mm',500,5.8],['5×2.5 mm',200,5.8],['4×3 mm',500,5.8],['4.5×3 mm',500,5.8],['5×3 mm',200,9.46],['6×3 mm',200,13.2],['4×3.5 mm',500,5.8],['6×4 mm',200,16.5],['7×5 mm',200,28.6],['8×4 mm',200,55],['9×7 mm',200,61.6]],
    'oval': [['2×1.5 mm',500,5.5],['2.5×1.5 mm',500,5.5],['3×2 mm',500,2],['3×2.5 mm',500,2.64],['3.5×2.5 mm',500,2.83],['4×2 mm',500,5.5],['4×3 mm',500,2.42],['4.5×3.5 mm',500,4.18],['5×3 mm',200,3.3],['5×4 mm',200,6.6],['5.5×4.5 mm',200,6.6],['6×4 mm',200,6.94],['7×5 mm',100,11.66],['8×5 mm',100,19.55],['8×6 mm',100,17.6],['9×6 mm',50,37.4],['9×7 mm',50,25.3],['10×7 mm',50,55],['10×8 mm',50,52.8],['11×8 mm',50,77],['11×9 mm',50,77],['12×8 mm',25,90.2],['12×9 mm',25,142.35],['12×10 mm',25,94.6],['16×12 mm',25,165],['14×10 mm',25,110],['14×12 mm',25,171.6],['15×11 mm',25,193.11],['18×13 mm',15,232.22]],
    'pear': [['2×1.5 mm',500,5.5],['2.5×1.5 mm',500,5.5],['3×2 mm',500,2],['3×2.5 mm',500,2.64],['3.5×2.5 mm',500,2.83],['4×2 mm',500,5.5],['4×3 mm',500,2.42],['4.5×3.5 mm',500,4.18],['5×3 mm',200,3.3],['5×4 mm',200,6.6],['5.5×4.5 mm',200,6.6],['6×4 mm',200,6.94],['7×5 mm',100,11.66],['8×5 mm',100,19.55],['8×6 mm',100,17.6],['9×6 mm',50,37.4],['9×7 mm',50,25.3],['10×7 mm',50,55],['10×8 mm',50,52.8],['11×8 mm',50,77],['11×9 mm',50,77],['12×8 mm',25,90.2],['12×9 mm',25,142.35],['12×10 mm',25,94.6],['16×12 mm',25,165],['14×10 mm',25,110],['14×12 mm',25,171.6],['15×11 mm',25,193.11],['18×13 mm',15,232.22]],
    'octagon-princess': [['3×2 mm',500,5.5],['4×2 mm',500,6.16],['4×3 mm',500,8.8],['5×4 mm',200,13.2],['5×3 mm',200,13.2],['6×4 mm',200,17.6],['7×5 mm',100,33],['8×6 mm',100,28.11],['9×7 mm',50,55],['10×8 mm',50,68.2],['11×9 mm',25,88],['12×10 mm',25,110],['14×10 mm',25,127.6],['15×10 mm',15,141.29],['16×12 mm',15,127.6]],
    'princess': [['1.5 mm',1000,2],['1.75 mm',1000,2],['2 mm',1000,2],['2.25 mm',500,2],['2.5 mm',500,2.2],['2.75 mm',500,2.2],['3 mm',500,2.42],['3.25 mm',200,4.4],['3.5 mm',200,4.84],['3.75 mm',200,5.94],['4 mm',200,5.06],['4.5 mm',200,9.46],['4.75 mm',100,9.96],['5 mm',100,11],['5.5 mm',100,20.51],['6 mm',100,19.36],['6.5 mm',100,35.2],['7 mm',100,39.6],['7.5 mm',100,47.79],['8 mm',50,48.4],['8.5 mm',50,60.5],['9 mm',50,49.87],['10 mm',25,72.72],['11 mm',25,103.89],['12 mm',25,132],['13 mm',25,275],['14 mm',25,297]],
    'heart': [['2.5 mm',200,7.21],['3 mm',200,4.08],['3.5 mm',200,9.46],['4 mm',200,6.38],['5 mm',100,11.88],['6 mm',100,18.7],['6.5 mm',100,34.94],['7 mm',100,33],['7.5 mm',50,57.2],['8 mm',50,48.4],['9 mm',50,70.4],['10 mm',25,77],['11 mm',25,127.6],['12 mm',25,149.6],['13 mm',25,198],['14 mm',25,253],['15 mm',25,297]],
    'triangle': [['3 mm',500,8.8],['3.5 mm',500,7.7],['4 mm',200,8.8],['5 mm',100,16.62],['6 mm',100,29.34],['7 mm',50,37.89],['8 mm',50,66],['9 mm',50,149.11],['10 mm',25,165]],
    'star': [['3 mm',200,8.67],['4 mm',200,12.1],['5 mm',100,18.16],['6 mm',100,28.6],['7 mm',50,46.38],['8 mm',50,38.5],['9 mm',50,72.87],['10 mm',25,77.14]],
    'asscher': [['3 mm',200,11],['4 mm',200,12.1],['5 mm',100,20.9],['6 mm',100,35.2],['7 mm',50,70.4],['8 mm',50,92.4],['9 mm',50,127.11],['10 mm',25,165]],
    'cushion': [['2 mm',200,5.5],['2.5 mm',200,6.16],['3 mm',200,9.72],['4 mm',200,13.59],['5 mm',100,18.7],['6 mm',100,28.6],['7 mm',50,39.6],['8 mm',50,53.78],['9 mm',50,61.11],['10 mm',25,88],['11 mm',25,145.44],['12 mm',25,198],['13 mm',25,198],['15 mm',25,286]],
    'octagon-step': [['3×2 mm',500,5.5],['4×2 mm',500,5.5],['4×3 mm',500,8.8],['5×3 mm',200,10.56],['5×4 mm',200,14.3],['6×4 mm',100,17.6],['7×5 mm',100,28.6],['8×6 mm',100,39.6],['9×7 mm',50,62.34],['10×8 mm',50,83.6],['11×9 mm',50,149.6],['12×10 mm',25,187],['12×9 mm',25,211.45],['14×10 mm',25,264]],
  },
  'aa|ruby2': {
    'princess': [['1.5 mm',1000,4.3],['1.75 mm',1000,4.3],['2 mm',1000,4.3],['2.25 mm',500,4.34],['2.5 mm',500,4.48],['2.75 mm',500,6.37],['3 mm',500,7],['3.25 mm',200,9.66],['3.5 mm',200,11.2],['4 mm',200,12.6],['4.5 mm',200,13.86],['5 mm',100,25.2],['5.5 mm',100,21.42],['6 mm',100,40.32],['7 mm',100,55.44],['8 mm',50,80.64],['9 mm',50,113.4]],
    'marquise': [['3×1.5 mm',500,4.55],['3×2 mm',500,6.3],['4×2 mm',500,5.04],['5×2.5 mm',200,7.56],['6×3 mm',200,12.04],['7×3.5 mm',200,20.16],['8×4 mm',100,28],['9×4.5 mm',100,47.6],['10×5 mm',50,50.4],['12×6 mm',25,72.8],['14×7 mm',25,106.4]],
    'oval': [['3×2 mm',500,4.48],['3.5×2.5 mm',500,10.08],['3×2.5 mm',500,8.33],['4×3 mm',500,8.68],['4.5×3.5 mm',500,16.38],['4×2.5 mm',500,16.38],['5×3 mm',200,10.08],['5×4 mm',200,15.4],['6×4 mm',200,16.63],['6×5 mm',200,32.76],['7×5 mm',100,26.46],['8×5 mm',100,32.76],['8×6 mm',100,37.8],['9×7 mm',50,56],['10×7 mm',50,64.4],['10×8 mm',50,75.6],['11×7 mm',50,99.4],['12×8 mm',25,103.6],['14×10 mm',25,163.8],['11×9 mm',50,103.6],['12×10 mm',25,134.4],['9×6 mm',50,47.6]],
    'pear': [['3×2 mm',500,4.48],['3.5×2.5 mm',500,10.08],['3×2.5 mm',500,8.33],['4×3 mm',500,8.68],['4.5×3.5 mm',500,16.38],['4×2.5 mm',500,16.38],['5×3 mm',200,10.08],['5×4 mm',200,15.4],['6×4 mm',200,16.63],['6×5 mm',200,32.76],['7×5 mm',100,26.46],['8×5 mm',100,32.76],['8×6 mm',100,37.8],['9×7 mm',50,56],['10×7 mm',50,64.4],['10×8 mm',50,75.6],['11×7 mm',50,99.4],['12×8 mm',25,103.6],['14×10 mm',25,163.8],['11×9 mm',50,103.6],['12×10 mm',25,134.4],['9×6 mm',50,47.6]],
    'asscher': [['3 mm',200,11.34],['4 mm',200,21.92],['5 mm',100,37.8],['6 mm',100,50.4],['7 mm',50,80.64],['8 mm',50,113.4],['9 mm',50,130.9],['10 mm',25,226.8]],
    'octagon-step': [['3×2 mm',500,12.1],['4×2 mm',500,7.56],['4×3 mm',500,16.38],['5×3 mm',200,11.34],['5×4 mm',200,19.6],['6×4 mm',100,23.94],['7×5 mm',100,42.84],['8×6 mm',100,64.82],['9×7 mm',50,84],['10×8 mm',50,106.4],['11×9 mm',50,172.8],['12×9 mm',25,207.36],['12×10 mm',25,183.6],['14×10 mm',25,237.6]],
    'octagon-princess': [['3×2 mm',500,12.1],['4×2 mm',500,7.56],['4×3 mm',500,16.38],['5×3 mm',200,11.34],['5×4 mm',200,19.6],['6×4 mm',200,23.94],['7×5 mm',100,42.84],['8×6 mm',100,64.82],['9×7 mm',50,84],['10×8 mm',50,106.4],['11×9 mm',25,172.8],['12×9 mm',25,207.36],['12×10 mm',25,183.6],['14×10 mm',25,237.6]],
    'triangle': [['3 mm',500,13.44],['4 mm',200,16.8],['5 mm',100,36.4],['6 mm',100,56],['7 mm',50,84],['8 mm',50,109.2],['9 mm',50,139.2],['10 mm',25,168]],
    'star': [['3 mm',200,12.6],['4 mm',200,20.16],['5 mm',100,29.23],['6 mm',100,48.38],['7 mm',50,90.72],['8 mm',50,118.8]],
    'cushion': [['2 mm',200,7.56],['3 mm',200,10.64],['4 mm',200,14.28],['5 mm',100,21],['6 mm',100,30.94],['7 mm',50,45.22],['8 mm',50,64.26],['9 mm',50,124.74],['10 mm',25,130.9]],
    'heart': [['3 mm',200,9.45],['3.5 mm',200,11.2],['4 mm',200,13.61],['5 mm',100,21.42],['6 mm',100,33.6],['7 mm',100,43.89],['8 mm',50,60],['9 mm',50,148.32],['10 mm',25,180]],
    'trillion': [['3 mm',200,12.04],['4 mm',200,18.2],['5 mm',100,28],['6 mm',100,44.8],['7 mm',50,64.4],['8 mm',50,92.4],['9 mm',50,120],['10 mm',25,151.2]],
    'round': [['0.70 mm',1000,1.13],['0.80 mm',1000,0.5],['0.90 mm',1000,0.42],['1.00 mm',1000,0.36],['1.10 mm',1000,0.45],['1.20 mm',1000,0.53],['1.30 mm',1000,0.6],['1.40 mm',1000,0.66],['1.50 mm',1000,0.73],['1.60 mm',1000,0.81],['1.70 mm',1000,0.9],['1.80 mm',1000,1.01],['1.90 mm',1000,1.13],['2.00 mm',1000,1.21],['2.10 mm',500,1.74],['2.20 mm',500,1.85],['2.25 mm',500,1.89],['2.30 mm',500,2.18],['2.40 mm',500,2.52],['2.50 mm',500,2.66],['2.60 mm',500,3.08],['2.75 mm',500,3.02],['2.80 mm',500,3.15],['2.90 mm',500,3.53],['3.00 mm',500,4.79],['3.25 mm',200,4.79],['3.50 mm',200,5.8],['3.75 mm',200,7.06],['4.00 mm',200,8.82],['4.50 mm',200,13.36],['5.00 mm',100,15.88],['5.50 mm',100,20.16],['6.00 mm',100,23.94],['6.50 mm',100,30.24],['7.00 mm',100,37.8],['7.50 mm',100,44.1],['8.00 mm',50,50.4],['9.00 mm',50,69.6]],
    'baguette': [['3×1.5 mm',1000,3.36],['1.5×1 mm',1000,3.28],['2×1 mm',1000,3.28],['2×1.5 mm',1000,3.36],['2.5×1.5 mm',1000,3.28],['3×2 mm',1000,5.04],['3.5×1.5 mm',500,3.53],['4×2 mm',500,5.04],['4.5×2 mm',500,8.82],['5×2.5 mm',200,9.8],['5×3 mm',200,12.6],['6×3 mm',200,17.64]],
    'tapered': [['3×2×1.5 mm',1000,4.2],['4×2×1.5 mm',500,4.54]],
  },
  'aa|ruby3': {
    'princess': [['1.5 mm',1000,4.3],['1.75 mm',1000,4.3],['2 mm',1000,4.3],['2.25 mm',500,4.34],['2.5 mm',500,4.48],['2.75 mm',500,6.37],['3 mm',500,7],['3.25 mm',200,9.66],['3.5 mm',200,11.2],['4 mm',200,12.6],['4.5 mm',200,13.86],['5 mm',100,25.2],['5.5 mm',100,21.42],['6 mm',100,40.32],['7 mm',100,55.44],['8 mm',50,80.64],['9 mm',50,113.4]],
    'marquise': [['3×1.5 mm',500,4.55],['3×2 mm',500,6.3],['4×2 mm',500,5.04],['5×2.5 mm',200,7.56],['6×3 mm',200,12.04],['7×3.5 mm',200,20.16],['8×4 mm',100,28],['9×4.5 mm',100,47.6],['10×5 mm',50,50.4],['12×6 mm',25,72.8],['14×7 mm',25,106.4]],
...
const RAJKOT_SHEETS = {
  'white-aaa|white': { 'round': [['1.00 mm',1000,0.0388],['1.10 mm',1000,0.04753],['1.20 mm',1000,0.0553],['1.30 mm',1000,0.06015],['1.40 mm',1000,0.07761],['1.50 mm',1000,0.09313],['1.60 mm',1000,0.10865],['1.70 mm',1000,0.12223],['1.80 mm',1000,0.14745],['1.90 mm',1000,0.17462],['2.00 mm',1000,0.17656],['2.10 mm',1000,0.27864],['2.20 mm',1000,0.29516],['2.30 mm',1000,0.30548],['2.40 mm',1000,0.3385],['2.50 mm',1000,0.3385],['2.60 mm',1000,0.42313],['2.70 mm',1000,0.4706],['2.80 mm',1000,0.49537],['2.90 mm',1000,0.51601],['3.00 mm',1000,0.53665]] },
  'color|ruby5aaa': { 'round': [['1.00 mm',1000,0.18489],['1.10 mm',1000,0.20338],['1.20 mm',1000,0.22187],['1.30 mm',1000,0.2496],['1.40 mm',1000,0.27733],['1.50 mm',1000,0.30507],['1.60 mm',1000,0.3328],['1.70 mm',1000,0.37902],['1.80 mm',1000,0.44373],['1.90 mm',1000,0.4992],['2.00 mm',1000,0.57316],['2.50 mm',1000,1.14631],['3.00 mm',1000,1.664],['4.00 mm',1000,3.32801]] },
  ...
  'color|pinkcz': { 'round': [['1.00 mm',1000,0.05755],['1.10 mm',1000,0.0633],['1.20 mm',1000,0.07673],['1.30 mm',1000,0.0844],['1.40 mm',1000,0.10166],['1.50 mm',1000,0.11126],['1.60 mm',1000,0.13427],['1.70 mm',1000,0.15346],['1.80 mm',1000,0.17647],['1.90 mm',1000,0.22059],['2.00 mm',1000,0.23018],['2.50 mm',1000,0.38364],['3.00 mm',1000,0.55628]] },
...
const BRACELET_BY_GRADE = {
  ...
  'omega': {
    imgPrefix: '/assets/products/bracelet-omega-',
    colors: [
      { id: 'grey', name: 'Grey', hex: '#A0ACA2' },
      { id: 'red', name: 'Red', hex: '#E03541' },
      { id: 'hot-pink', name: 'Hot Pink', hex: '#E3314A' },
      { id: 'plum', name: 'Plum', hex: '#5D4371' },
      { id: 'pink', name: 'Pink', hex: '#E19D94' },
      { id: 'beige', name: 'Beige', hex: '#AFA496' },
      { id: 'hot-pink-2', name: 'Hot Pink 2', hex: '#EA3F74' },
      { id: 'pink-2', name: 'Pink 2', hex: '#D46BB1' },
      { id: 'rose-pink', name: 'Rose Pink', hex: '#AA5384' },
      { id: 'charcoal', name: 'Charcoal', hex: '#484446' },
      { id: 'red-2', name: 'Red 2', hex: '#DF182C' },
      { id: 'sky-blue', name: 'Sky Blue', hex: '#73A3CE' },
      { id: 'pink-3', name: 'Pink 3', hex: '#E5ADAB' },
      { id: 'silver', name: 'Silver', hex: '#BABBB9' },
      { id: 'olive', name: 'Olive', hex: '#937049' },
      { id: 'olive-2', name: 'Olive 2', hex: '#78622C' },
      { id: 'brown', name: 'Brown', hex: '#614A40' },
      { id: 'red-3', name: 'Red 3', hex: '#D52B3D' },
      { id: 'blue', name: 'Blue', hex: '#2D6BBF' },
      { id: 'baby-pink', name: 'Baby Pink', hex: '#F3BAC1' },
      { id: 'green', name: 'Green', hex: '#44A973' },
      { id: 'violet', name: 'Violet', hex: '#5B4AA8' },
      { id: 'hot-pink-3', name: 'Hot Pink 3', hex: '#DE2F65' },
      { id: 'green-2', name: 'Green 2', hex: '#3C9358' },
    ],
  },
  'crimson': {
    imgPrefix: '/assets/products/bracelet-crimson-',
    colors: [
      { id: 'black', name: 'Black', hex: '#2B2B2B' },
      { id: 'brown', name: 'Brown', hex: '#5A3A28' },
      { id: 'off-white', name: 'Off White', hex: '#ECE7DA' },
      { id: 'red', name: 'Red', hex: '#C0202E' },
      { id: 'pink', name: 'Pink', hex: '#E08AA0' },
    ],
  },
  'matrix': {
    imgPrefix: '/assets/products/bracelet-matrix-',
    colors: [
      { id: 'rose-gold', name: 'Rose Gold', hex: '#B98A6A' },
      { id: 'blue', name: 'Blue', hex: '#274B7A' },
      { id: 'gold', name: 'Gold', hex: '#C9A227' },
      { id: 'silver', name: 'Silver', hex: '#BFC2C6' },
      { id: 'black', name: 'Black', hex: '#2E2E2E' },
    ],
  },
  'obsidian': {
    imgPrefix: '/assets/products/bracelet-obsidian-',
    colors: [
      { id: 'rose-gold', name: 'Rose Gold', hex: '#C7987A' },
      { id: 'silver', name: 'Silver', hex: '#B9BCC0' },
      { id: 'blue', name: 'Blue', hex: '#28517E' },
      { id: 'black', name: 'Black', hex: '#2A2A2C' },
      { id: 'gold', name: 'Gold', hex: '#C9A227' },
    ],
  },
  'gents-heavy': {
    imgPrefix: '/assets/products/bracelet-gents-heavy-',
    colors: [
      { id: 'black', name: 'Black', hex: '#3E3E3D' },
      { id: 'tan', name: 'Tan', hex: '#6F5C4D' },
      { id: 'black-2', name: 'Black 2', hex: '#494847' },
      { id: 'green', name: 'Green', hex: '#358660' },
      { id: 'forest-green', name: 'Forest Green', hex: '#444A46' },
      { id: 'orange', name: 'Orange', hex: '#403B35' },
      { id: 'navy-blue', name: 'Navy Blue', hex: '#495469' },
      { id: 'green-2', name: 'Green 2', hex: '#4C5B55' },
      { id: 'black-3', name: 'Black 3', hex: '#403F3F' },
      { id: 'red', name: 'Red', hex: '#5D4141' },
      { id: 'vintage-brown', name: 'Vintage Brown', hex: '#6D6257' },
      { id: 'green-3', name: 'Green 3', hex: '#3F8863' },
      { id: 'orange-2', name: 'Orange 2', hex: '#C56130' },
      { id: 'grey', name: 'Grey', hex: '#414141' },
      { id: 'black-4', name: 'Black 4', hex: '#3A3A3A' },
      { id: 'red-2', name: 'Red 2', hex: '#BD4C4B' },
      { id: 'mint-green', name: 'Mint Green', hex: '#94B6A0' },
      { id: 'red-3', name: 'Red 3', hex: '#B24343' },
      { id: 'red-4', name: 'Red 4', hex: '#BE4443' },
      { id: 'navy-blue-2', name: 'Navy Blue 2', hex: '#4F4F5A' },
    ],
  },
  'magnetic-halo': {
    imgPrefix: '/assets/products/bracelet-magnetic-halo-',
    colors: [
      { id: 'chocolate', name: 'Chocolate', hex: '#464422' },
      { id: 'orange', name: 'Orange', hex: '#D2610B' },
      { id: 'chocolate-2', name: 'Chocolate 2', hex: '#3B3122' },
      { id: 'burgundy', name: 'Burgundy', hex: '#5E1E2D' },
      { id: 'brown', name: 'Brown', hex: '#71352E' },
      { id: 'grey', name: 'Grey', hex: '#797A75' },
      { id: 'teal', name: 'Teal', hex: '#298073' },
      { id: 'silver', name: 'Silver', hex: '#C9C9C8' },
      { id: 'chocolate-3', name: 'Chocolate 3', hex: '#3F1A36' },
      { id: 'rust', name: 'Rust', hex: '#A46809' },
      { id: 'navy', name: 'Navy', hex: '#1B386A' },
      { id: 'silver-2', name: 'Silver 2', hex: '#CBC6AE' },
      { id: 'silver-3', name: 'Silver 3', hex: '#C2C2C5' },
      { id: 'crimson', name: 'Crimson', hex: '#9E171C' },
      { id: 'crimson-2', name: 'Crimson 2', hex: '#990405' },
      { id: 'beige', name: 'Beige', hex: '#A9A29B' },
      { id: 'violet', name: 'Violet', hex: '#445699' },
      { id: 'navy-2', name: 'Navy 2', hex: '#24265E' },
      { id: 'olive', name: 'Olive', hex: '#76631A' },
      { id: 'navy-3', name: 'Navy 3', hex: '#182C6C' },
      { id: 'rust-2', name: 'Rust 2', hex: '#AA4519' },
      { id: 'navy-4', name: 'Navy 4', hex: '#20384D' },
      { id: 'olive-2', name: 'Olive 2', hex: '#6E6E6A' },
      { id: 'crimson-3', name: 'Crimson 3', hex: '#AA2020' },
      { id: 'charcoal', name: 'Charcoal', hex: '#5C5C45' },
      { id: 'grey-2', name: 'Grey 2', hex: '#678981' },
      { id: 'crimson-4', name: 'Crimson 4', hex: '#9D1116' },
      { id: 'grey-3', name: 'Grey 3', hex: '#887A9E' },
      { id: 'lime', name: 'Lime', hex: '#72D524' },
      { id: 'chocolate-4', name: 'Chocolate 4', hex: '#3C1B22' },
      { id: 'maroon', name: 'Maroon', hex: '#87152A' },
      { id: 'royal-blue', name: 'Royal Blue', hex: '#162D7D' },
      { id: 'charcoal-2', name: 'Charcoal 2', hex: '#4D4D5C' },
      { id: 'plum', name: 'Plum', hex: '#726476' },
      { id: 'brown-2', name: 'Brown 2', hex: '#5F3A1C' },
      { id: 'maroon-2', name: 'Maroon 2', hex: '#7A0508' },
      { id: 'tan', name: 'Tan', hex: '#8D7E67' },
      { id: 'grey-4', name: 'Grey 4', hex: '#5D718F' },
      { id: 'wine', name: 'Wine', hex: '#88333E' },
      { id: 'navy-5', name: 'Navy 5', hex: '#27313F' },
      { id: 'blue', name: 'Blue', hex: '#08639B' },
      { id: 'olive-3', name: 'Olive 3', hex: '#7C785A' },
      { id: 'royal-blue-2', name: 'Royal Blue 2', hex: '#331F84' },
      { id: 'rose-gold', name: 'Rose Gold', hex: '#C58D95' },
      { id: 'maroon-3', name: 'Maroon 3', hex: '#81361D' },
      { id: 'charcoal-3', name: 'Charcoal 3', hex: '#595958' },
      { id: 'brown-3', name: 'Brown 3', hex: '#494D20' },
      { id: 'green', name: 'Green', hex: '#3F7B17' },
      { id: 'olive-4', name: 'Olive 4', hex: '#85752A' },
      { id: 'plum-2', name: 'Plum 2', hex: '#894E5B' },
      { id: 'orange-2', name: 'Orange 2', hex: '#CD531D' },
      { id: 'olive-5', name: 'Olive 5', hex: '#706540' },
      { id: 'charcoal-4', name: 'Charcoal 4', hex: '#3C4A6B' },
      { id: 'grey-5', name: 'Grey 5', hex: '#807876' },
      { id: 'charcoal-5', name: 'Charcoal 5', hex: '#465A40' },
      { id: 'charcoal-6', name: 'Charcoal 6', hex: '#5B5E5A' },
      { id: 'crimson-5', name: 'Crimson 5', hex: '#8F0410' },
      { id: 'teal-2', name: 'Teal 2', hex: '#138992' },
      { id: 'plum-3', name: 'Plum 3', hex: '#955B62' },
      { id: 'silver-4', name: 'Silver 4', hex: '#B1B3B6' },
      { id: 'emerald', name: 'Emerald', hex: '#32775E' },
      { id: 'rose-pink', name: 'Rose Pink', hex: '#D1778F' },
      { id: 'navy-6', name: 'Navy 6', hex: '#212C49' },
      { id: 'olive-6', name: 'Olive 6', hex: '#737063' },
      { id: 'maroon-4', name: 'Maroon 4', hex: '#881319' },
      { id: 'rust-3', name: 'Rust 3', hex: '#A35113' },
      { id: 'violet-2', name: 'Violet 2', hex: '#5D3989' },
    ],
  },
  'designer-rakhi': {
    imgPrefix: '/assets/products/bracelet-designer-rakhi-',
    colors: [
      { id: 'blue', name: 'Blue', hex: '#1D50A9' },
      { id: 'navy', name: 'Navy', hex: '#252865' },
      { id: 'navy-2', name: 'Navy 2', hex: '#292D62' },
      { id: 'navy-3', name: 'Navy 3', hex: '#311E4F' },
      { id: 'charcoal', name: 'Charcoal', hex: '#54534B' },
      { id: 'chocolate', name: 'Chocolate', hex: '#3F332E' },
      { id: 'orange', name: 'Orange', hex: '#D36107' },
      { id: 'rust', name: 'Rust', hex: '#976406' },
      { id: 'grey', name: 'Grey', hex: '#837F74' },
      { id: 'emerald', name: 'Emerald', hex: '#10572A' },
      { id: 'rust-2', name: 'Rust 2', hex: '#913526' },
      { id: 'brown', name: 'Brown', hex: '#5E2B21' },
      { id: 'charcoal-2', name: 'Charcoal 2', hex: '#523545' },
      { id: 'plum', name: 'Plum', hex: '#634B55' },
      { id: 'charcoal-3', name: 'Charcoal 3', hex: '#465144' },
      { id: 'tan', name: 'Tan', hex: '#9B785A' },
      { id: 'silver', name: 'Silver', hex: '#C8C0B5' },
      { id: 'silver-2', name: 'Silver 2', hex: '#C1BCB5' },
      { id: 'grey-2', name: 'Grey 2', hex: '#908C8C' },
      { id: 'silver-3', name: 'Silver 3', hex: '#C2C0BE' },
      { id: 'burgundy', name: 'Burgundy', hex: '#512129' },
      { id: 'chocolate-2', name: 'Chocolate 2', hex: '#481119' },
      { id: 'grey-3', name: 'Grey 3', hex: '#94897F' },
      { id: 'grey-4', name: 'Grey 4', hex: '#89756E' },
      { id: 'sky-blue', name: 'Sky Blue', hex: '#77AFB7' },
      { id: 'rose-pink', name: 'Rose Pink', hex: '#B97174' },
      { id: 'pink', name: 'Pink', hex: '#D49CA3' },
      { id: 'crimson', name: 'Crimson', hex: '#8E1346' },
      { id: 'crimson-2', name: 'Crimson 2', hex: '#8D2229' },
      { id: 'maroon', name: 'Maroon', hex: '#83151C' },
      { id: 'maroon-2', name: 'Maroon 2', hex: '#820C24' },
    ],
  },
  'alpha': {
    imgPrefix: '/assets/products/bracelet-alpha-',
    colors: [
      { id: 'rust', name: 'Rust', hex: '#9A452D' },
      { id: 'charcoal', name: 'Charcoal', hex: '#434073' },
      { id: 'grey', name: 'Grey', hex: '#81ADA7' },
      { id: 'rust-2', name: 'Rust 2', hex: '#A74433' },
      { id: 'rust-3', name: 'Rust 3', hex: '#9E5D30' },
      { id: 'hot-pink', name: 'Hot Pink', hex: '#DA3891' },
      { id: 'wine', name: 'Wine', hex: '#743337' },
      { id: 'beige', name: 'Beige', hex: '#A8A6A4' },
      { id: 'rust-4', name: 'Rust 4', hex: '#AD3530' },
      { id: 'olive', name: 'Olive', hex: '#846654' },
      { id: 'brown', name: 'Brown', hex: '#79442C' },
      { id: 'grey-2', name: 'Grey 2', hex: '#926583' },
      { id: 'tan', name: 'Tan', hex: '#917951' },
      { id: 'green', name: 'Green', hex: '#488C43' },
      { id: 'brown-2', name: 'Brown 2', hex: '#784832' },
      { id: 'purple', name: 'Purple', hex: '#77467D' },
      { id: 'pink', name: 'Pink', hex: '#D09EB3' },
      { id: 'charcoal-2', name: 'Charcoal 2', hex: '#533F56' },
      { id: 'green-2', name: 'Green 2', hex: '#5C8D63' },
      { id: 'sky-blue', name: 'Sky Blue', hex: '#5690B5' },
      { id: 'pink-2', name: 'Pink 2', hex: '#C5939E' },
      { id: 'grey-3', name: 'Grey 3', hex: '#94B7A4' },
      { id: 'olive-2', name: 'Olive 2', hex: '#837352' },
      { id: 'rust-5', name: 'Rust 5', hex: '#8B4F31' },
      { id: 'wine-2', name: 'Wine 2', hex: '#803635' },
      { id: 'olive-3', name: 'Olive 3', hex: '#8D5D38' },
      { id: 'beige-2', name: 'Beige 2', hex: '#D2A7AB' },
      { id: 'wine-3', name: 'Wine 3', hex: '#762B2A' },
      { id: 'wine-4', name: 'Wine 4', hex: '#622837' },
      { id: 'olive-4', name: 'Olive 4', hex: '#8F672D' },
      { id: 'grey-4', name: 'Grey 4', hex: '#797674' },
      { id: 'violet', name: 'Violet', hex: '#62498F' },
      { id: 'plum', name: 'Plum', hex: '#864B75' },
      { id: 'plum-2', name: 'Plum 2', hex: '#7E4944' },
      { id: 'silver', name: 'Silver', hex: '#C8B9C4' },
      { id: 'wine-5', name: 'Wine 5', hex: '#7D3133' },
      { id: 'grey-5', name: 'Grey 5', hex: '#928B7D' },
      { id: 'brown-3', name: 'Brown 3', hex: '#614E39' },
      { id: 'brown-4', name: 'Brown 4', hex: '#62492A' },
      { id: 'coral', name: 'Coral', hex: '#C86057' },
      { id: 'olive-5', name: 'Olive 5', hex: '#926630' },
      { id: 'silver-2', name: 'Silver 2', hex: '#ADCACE' },
      { id: 'grey-6', name: 'Grey 6', hex: '#667191' },
      { id: 'brown-5', name: 'Brown 5', hex: '#5F4B34' },
      { id: 'grey-7', name: 'Grey 7', hex: '#797677' },
      { id: 'plum-3', name: 'Plum 3', hex: '#873D46' },
      { id: 'plum-4', name: 'Plum 4', hex: '#892557' },
      { id: 'sky-blue-2', name: 'Sky Blue 2', hex: '#759BB3' },
      { id: 'plum-5', name: 'Plum 5', hex: '#9F275F' },
      { id: 'violet-2', name: 'Violet 2', hex: '#4D3F80' },
      { id: 'navy', name: 'Navy', hex: '#39276A' },
      { id: 'cyan', name: 'Cyan', hex: '#40A4DA' },
      { id: 'black', name: 'Black', hex: '#242324' },
      { id: 'maroon', name: 'Maroon', hex: '#872C2E' },
      { id: 'plum-6', name: 'Plum 6', hex: '#802458' },
      { id: 'brown-6', name: 'Brown 6', hex: '#70473E' },
      { id: 'plum-7', name: 'Plum 7', hex: '#805F73' },
      { id: 'teal', name: 'Teal', hex: '#1A6F86' },
      { id: 'plum-8', name: 'Plum 8', hex: '#953E68' },
      { id: 'silver-3', name: 'Silver 3', hex: '#B3BCB6' },
      { id: 'brown-7', name: 'Brown 7', hex: '#745237' },
      { id: 'plum-9', name: 'Plum 9', hex: '#803558' },
      { id: 'brown-8', name: 'Brown 8', hex: '#7D4430' },
      { id: 'cyan-2', name: 'Cyan 2', hex: '#2FACC7' },
      { id: 'plum-10', name: 'Plum 10', hex: '#7A5F71' },
      { id: 'olive-6', name: 'Olive 6', hex: '#7C5534' },
      { id: 'olive-7', name: 'Olive 7', hex: '#8A5F57' },
      { id: 'grey-8', name: 'Grey 8', hex: '#88969C' },
      { id: 'silver-4', name: 'Silver 4', hex: '#C5C0B1' },
      { id: 'rust-6', name: 'Rust 6', hex: '#BB434B' },
      { id: 'pink-3', name: 'Pink 3', hex: '#DF96C8' },
      { id: 'hot-pink-2', name: 'Hot Pink 2', hex: '#DE4496' },
      { id: 'plum-11', name: 'Plum 11', hex: '#5C2D65' },
      { id: 'grey-9', name: 'Grey 9', hex: '#858090' },
      { id: 'silver-5', name: 'Silver 5', hex: '#B3CBBD' },
      { id: 'emerald', name: 'Emerald', hex: '#1F7036' },
      { id: 'silver-6', name: 'Silver 6', hex: '#94C0D4' },
      { id: 'olive-8', name: 'Olive 8', hex: '#765836' },
      { id: 'plum-12', name: 'Plum 12', hex: '#5E686E' },
      { id: 'beige-3', name: 'Beige 3', hex: '#C9D7A2' },
      { id: 'olive-9', name: 'Olive 9', hex: '#925D51' },
      { id: 'silver-7', name: 'Silver 7', hex: '#BBBBC0' },
      { id: 'rust-7', name: 'Rust 7', hex: '#88503A' },
      { id: 'plum-13', name: 'Plum 13', hex: '#904C68' },
    ],
  },
};
const BRACELET_HERO = {
  ...
  matrix: '/assets/products/bracelet-matrix-hero.jpeg?v=3',
  obsidian: '/assets/products/bracelet-obsidian-hero.jpeg?v=3',
  omega: '/assets/products/bracelet-omega-hero.jpeg?v=3',
  'magnetic-halo': '/assets/products/bracelet-magnetic-halo-hero.jpeg?v=3',
  'designer-rakhi': '/assets/products/bracelet-designer-rakhi-hero.jpeg?v=3',
  crimson: '/assets/products/bracelet-crimson-hero.jpeg?v=3',
  'gents-heavy': '/assets/products/bracelet-gents-heavy-hero.jpeg?v=3',
  alpha: '/assets/products/bracelet-alpha-hero.jpeg?v=3',
};
...
// the backend grade id differs from the built-in key (e.g. "magnetic-halo-1").
const BRACELET_STYLE_TOKENS = {
  rolex: 'rolex', cartier: 'cartier', matrix: 'matrix', obsidian: 'obsidian',
  omega: 'omega', crimson: 'crimson', halo: 'magnetic-halo', magnetic: 'magnetic-halo',
  rakhi: 'designer-rakhi', gents: 'gents-heavy',
};
function braceletStyleFor(grade) {
  if (!grade) return null;
  if (BRACELET_BY_GRADE[grade.id]) return BRACELET_BY_GRADE[grade.id];
  const n = String(grade.name || '').toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/^-+|-+$/g, '');
  if (BRACELET_BY_GRADE[n]) return BRACELET_BY_GRADE[n];
  const hay = (String(grade.id || '') + ' ' + String(grade.name || '')).toLowerCase();
  for (const tok in BRACELET_STYLE_TOKENS) {
    if (hay.indexOf(tok) !== -1 && BRACELET_BY_GRADE[BRACELET_STYLE_TOKENS[tok]]) return BRACELET_BY_GRADE[BRACELET_STYLE_TOKENS[tok]];
  }
  return null;
}
window.braceletStyleFor = braceletStyleFor;
...
Object.assign(window, {
  ...
  PEARL_SHAPES_BY_GRADE, NAVRATNA_SHAPES_BY_GRADE, OPAQUE_COLORS_BY_GRADE, PEARL_COLORS_BY_GRADE, CORUNDUM_COLORS_BY_GRADE, LABGROWN_COLORS_BY_GRADE, CZ_COLORS_BY_GRADE, RAJKOT_COLORS_BY_GRADE, SIZES_BY_CATEGORY, POLKI_SERIES_DESIGNS, POLKI_SAMOSA_DESIGNS,
