...
const POLKI_SAMOSA_DESIGNS = {
  b: [
    { id: 'b-4-r', name: 'B-4 R', dims: [4,6.3], price: 28, wt: 0.11, pcsPerPacket: 1000 },
    { id: 'b-4-l', name: 'B-4 L', dims: [4,6.3], price: 28, wt: 0.113, pcsPerPacket: 1000 },
    { id: 'b-5-r', name: 'B-5 R', dims: [3.7,6.5], price: 28, wt: 0.106, pcsPerPacket: 1000 },
    { id: 'b-5-l', name: 'B-5 L', dims: [3.7,6.5], price: 28, wt: 0.104, pcsPerPacket: 1000 },
    { id: 'b-6-r', name: 'B-6 R', dims: [3.5,6.2], price: 28, wt: 0.089, pcsPerPacket: 1000 },
    { id: 'b-6-l', name: 'B-6 L', dims: [3.5,6.2], price: 28, wt: 0.087, pcsPerPacket: 1000 },
  ],
  c: [
    { id: 'c-2', name: 'C-2', dims: [5,7], price: 28, wt: 0.166, pcsPerPacket: 1000 },
    { id: 'c-3-r', name: 'C-3 R', dims: [7,7], price: 30, wt: 0.201, pcsPerPacket: 1000 },
    { id: 'c-3-l', name: 'C-3 L', dims: [7,7], price: 30, wt: 0.205, pcsPerPacket: 1000 },
    { id: 'c-4', name: 'C-4', dims: [5.4,6.9], price: 28, wt: 0.174, pcsPerPacket: 1000 },
    { id: 'c-5-r', name: 'C-5 R', dims: [5,6], price: 28, wt: 0.132, pcsPerPacket: 1000 },
    { id: 'c-5-l', name: 'C-5 L', dims: [5,6], price: 28, wt: 0.132, pcsPerPacket: 1000 },
    { id: 'c-7-r', name: 'C-7 R', dims: [5.6,6.4], price: 28, wt: 0.162, pcsPerPacket: 1000 },
    { id: 'c-7-l', name: 'C-7 L', dims: [5.6,6.4], price: 28, wt: 0.158, pcsPerPacket: 1000 },
    { id: 'c-8', name: 'C-8', dims: [6.3,7.4], price: 30, wt: 0.207, pcsPerPacket: 1000 },
    { id: 'c-9-r', name: 'C-9 R', dims: [4,6.5], price: 28, wt: 0.113, pcsPerPacket: 1000 },
    { id: 'c-9-l', name: 'C-9 L', dims: [4,6.5], price: 28, wt: 0.12, pcsPerPacket: 1000 },
  ],
  x: [
    { id: 'x-1', name: 'X-1', dims: [3.2,4.2], price: 25, wt: 0.046, pcsPerPacket: 1000 },
    { id: 'x-2', name: 'X-2', dims: [3.5,3.8], price: 25, wt: 0.052, pcsPerPacket: 1000 },
    { id: 'x-3-l', name: 'X-3 L', dims: [3,3.8], price: 25, wt: 0.04, pcsPerPacket: 1000 },
    { id: 'x-4', name: 'X-4', dims: [3,3.4], price: 25, wt: 0.046, pcsPerPacket: 1000 },
    { id: 'x-5', name: 'X-5', dims: [3.6,4], price: 25, wt: 0.063, pcsPerPacket: 1000 },
    { id: 'x-6-r', name: 'X-6 R', dims: [3,4], price: 25, wt: 0.05, pcsPerPacket: 1000 },
    { id: 'x-6-l', name: 'X-6 L', dims: [3,4], price: 25, wt: 0.047, pcsPerPacket: 1000 },
    { id: 'x-7', name: 'X-7', dims: [2,3.6,3.7], price: 25, wt: 0.056, pcsPerPacket: 1000 },
    { id: 'x-8', name: 'X-8', dims: [3,3.2], price: 25, wt: 0.033, pcsPerPacket: 1000 },
    { id: 'x-9', name: 'X-9', dims: [3.2,3.6], price: 25, wt: 0.05, pcsPerPacket: 1000 },
    { id: 'x-9-323', name: 'X-9', dims: [3.2,3.6], price: 25, wt: null, pcsPerPacket: 1000 },
    { id: 'x-10', name: 'X-10', dims: [2.8,4.2], price: 25, wt: 0.054, pcsPerPacket: 1000 },
    { id: 'x-12', name: 'X-12', dims: [2.8,3.8], price: 25, wt: 0.041, pcsPerPacket: 1000 },
    { id: 'x-13', name: 'X-13', dims: [3.7,3.8], price: 25, wt: 0.038, pcsPerPacket: 1000 },
    { id: 'x-15', name: 'X-15', dims: [3.3,4.3], price: 25, wt: 0.055, pcsPerPacket: 1000 },
    { id: 'x-16', name: 'X-16', dims: [3.9,3.9], price: 25, wt: 0.051, pcsPerPacket: 1000 },
    { id: 'x-17-r', name: 'X-17 R', dims: [3.3,3.7], price: 25, wt: 0.04, pcsPerPacket: 1000 },
    { id: 'x-17-l', name: 'X-17 L', dims: [3.3,3.7], price: 25, wt: 0.041, pcsPerPacket: 1000 },
    { id: 'x-18', name: 'X-18', dims: [3.6,4.2], price: 25, wt: 0.063, pcsPerPacket: 1000 },
    { id: 'x-19', name: 'X-19', dims: [3.6,3.8], price: 25, wt: 0.059, pcsPerPacket: 1000 },
    { id: 'x-20', name: 'X-20', dims: [3,3.5], price: 25, wt: 0.043, pcsPerPacket: 1000 },
    { id: 'x-21-r', name: 'X-21 R', dims: [3.3,4.3], price: 25, wt: 0.047, pcsPerPacket: 1000 },
    { id: 'x-21-l', name: 'X-21 L', dims: [3.3,4.3], price: 25, wt: 0.046, pcsPerPacket: 1000 },
    { id: 'x-22-r', name: 'X-22 R', dims: [3.6,3.9], price: 25, wt: 0.064, pcsPerPacket: 1000 },
    { id: 'x-22-l', name: 'X-22 L', dims: [3.6,3.9], price: 25, wt: 0.056, pcsPerPacket: 1000 },
    { id: 'x-23', name: 'X-23', dims: [3.8,3.8], price: 25, wt: 0.059, pcsPerPacket: 1000 },
  ],
  z: [
    { id: 'z-1-r', name: 'Z-1 R', dims: [9,10], price: 40, wt: 0.418, pcsPerPacket: 1000 },
    { id: 'z-2-l', name: 'Z-2 L', dims: [9,10], price: 40, wt: 0.429, pcsPerPacket: 1000 },
    { id: 'z-3-r', name: 'Z-3 R', dims: [5.9,9.2], price: 35, wt: 0.237, pcsPerPacket: 1000 },
    { id: 'z-3-l', name: 'Z-3 L', dims: [5.9,9.2], price: 35, wt: 0.24, pcsPerPacket: 1000 },
    { id: 'z-4', name: 'Z-4', dims: [7.7,10.7], price: 35, wt: 0.373, pcsPerPacket: 1000 },
    { id: 'z-5-r', name: 'Z-5 R', dims: [7.3,8.1], price: 35, wt: 0.298, pcsPerPacket: 1000 },
    { id: 'z-5-l', name: 'Z-5 L', dims: [7.3,8.1], price: 35, wt: 0.301, pcsPerPacket: 1000 },
    { id: 'z-6-r', name: 'Z-6 R', dims: [7.2,9.3], price: 40, wt: 0.319, pcsPerPacket: 1000 },
    { id: 'z-7-r', name: 'Z-7 R', dims: [6.2,7.2], price: 35, wt: 0.188, pcsPerPacket: 1000 },
    { id: 'z-9', name: 'Z-9', dims: [5.4,8.4], price: 35, wt: 0.203, pcsPerPacket: 1000 },
    { id: 'z-10', name: 'Z-10', dims: [7.3,7.7], price: 35, wt: 0.253, pcsPerPacket: 1000 },
    { id: 'z-14', name: 'Z-14', dims: [6.5,8], price: 35, wt: 0.234, pcsPerPacket: 1000 },
    { id: 'z-15-r', name: 'Z-15 R', dims: [4.9,9.9], price: 35, wt: 0.207, pcsPerPacket: 1000 },
    { id: 'z-15', name: 'Z-15', dims: [4.9], price: 35, wt: 0.223, pcsPerPacket: 1000 },
    { id: 'z-17-r', name: 'Z-17 R', dims: [7.4,8], price: 35, wt: 0.261, pcsPerPacket: 1000 },
    { id: 'z-17-l', name: 'Z-17 L', dims: [7.4,8], price: 35, wt: 0.272, pcsPerPacket: 1000 },
    { id: 'z-19-r', name: 'Z-19 R', dims: [6,7], price: 35, wt: 0.175, pcsPerPacket: 1000 },
    { id: 'z-20-r', name: 'Z-20 R', dims: [6.8,8.5], price: 35, wt: 0.237, pcsPerPacket: 1000 },
    { id: 'z-20-l', name: 'Z-20 L', dims: [6.8,8.5], price: 35, wt: 0.248, pcsPerPacket: 1000 },
    { id: 'z-21', name: 'Z-21', dims: [4.7,8.6], price: 35, wt: 0.176, pcsPerPacket: 1000 },
    { id: 'z-22', name: 'Z-22', dims: [7.1,8.1], price: 35, wt: 0.262, pcsPerPacket: 1000 },
    { id: 'z-25', name: 'Z-25', dims: [5.5,10.5], price: 35, wt: 0.264, pcsPerPacket: 1000 },
    { id: 'z-26', name: 'Z-26', dims: [6.3,8.3], price: 35, wt: 0.239, pcsPerPacket: 1000 },
    { id: 'z-27-r', name: 'Z-27 R', dims: [6.7,10.7], price: 40, wt: 0.32, pcsPerPacket: 1000 },
    { id: 'z-27-l', name: 'Z-27 L', dims: [6.7,10.7], price: 40, wt: 0.328, pcsPerPacket: 1000 },
  ],
  pcj: [
    { id: 'pcj-3', name: 'PCJ-3', dims: [4.5,6.8], price: 30, wt: 0.136, pcsPerPacket: 1000 },
    { id: 'pcj-4', name: 'PCJ-4', dims: [6,8.5], price: 35, wt: 0.21, pcsPerPacket: 1000 },
    { id: 'pcj-5', name: 'PCJ-5', dims: [6.5,9], price: 35, wt: 0.253, pcsPerPacket: 1000 },
    { id: 'pcj-6', name: 'PCJ-6', dims: [8,11], price: 40, wt: 0.46, pcsPerPacket: 1000 },
    { id: 'pcj-7', name: 'PCJ-7', dims: [9,13], price: 45, wt: 0.625, pcsPerPacket: 1000 },
    { id: 'pcj-8', name: 'PCJ-8', dims: [8,12], price: 40, wt: 0.509, pcsPerPacket: 1000 },
  ],
  gj: [
    { id: 'gj-1', name: 'GJ-1', dims: [2.5,4.4], price: 25, wt: 0.0043, pcsPerPacket: 1000 },
    { id: 'gj-2-r', name: 'GJ-2 R', dims: [2.9,5], price: 25, wt: 0.0057, pcsPerPacket: 1000 },
    { id: 'gj-2-l', name: 'GJ-2 L', dims: [2.9,5], price: 25, wt: 0.0055, pcsPerPacket: 1000 },
    { id: 'gj-3-r', name: 'GJ-3 R', dims: [2.9,5.8], price: 28, wt: 0.0062, pcsPerPacket: 1000 },
    { id: 'gj-3-l', name: 'GJ-3 L', dims: [2.9,5.8], price: 28, wt: 0.0066, pcsPerPacket: 1000 },
    { id: 'gj-4', name: 'GJ-4', dims: [2,3,3.5], price: 25, wt: 0.0052, pcsPerPacket: 1000 },
    { id: 'gj-5', name: 'GJ-5', dims: [2.5,4,4], price: 25, wt: 0.0066, pcsPerPacket: 1000 },
    { id: 'gj-6', name: 'GJ-6', dims: [2.6,5.2], price: 25, wt: 0.0053, pcsPerPacket: 1000 },
    { id: 'gj-7', name: 'GJ-7', dims: [2,3,3], price: 25, wt: 0.0039, pcsPerPacket: 1000 },
    { id: 'gj-8-r', name: 'GJ-8 R', dims: [2.5,3.2], price: 25, wt: 0.0031, pcsPerPacket: 1000 },
    { id: 'gj-8-l', name: 'GJ-8 L', dims: [2.5,3.2], price: 25, wt: 0.0032, pcsPerPacket: 1000 },
    { id: 'gj-9', name: 'GJ-9', dims: [2,4.5,5], price: 28, wt: 0.0082, pcsPerPacket: 1000 },
    { id: 'gj-10', name: 'GJ-10', dims: [2.5,3], price: 25, wt: 0.0028, pcsPerPacket: 1000 },
    { id: 'gj-11', name: 'GJ-11', dims: [3,4,5], price: 28, wt: 0.009, pcsPerPacket: 1000 },
    { id: 'gj-12', name: 'GJ-12', dims: [3.5,4.4], price: 28, wt: 0.0058, pcsPerPacket: 1000 },
    { id: 'gj-13', name: 'GJ-13', dims: [3.5,4.5], price: 28, wt: 0.006, pcsPerPacket: 1000 },
    { id: 'gj-14', name: 'GJ-14', dims: [3.5,3.5], price: 25, wt: 0.0035, pcsPerPacket: 1000 },
    { id: 'gj-15', name: 'GJ-15', dims: [3.6,5], price: 28, wt: 0.0065, pcsPerPacket: 1000 },
    { id: 'gj-16-r', name: 'GJ-16 R', dims: [3,6.7], price: 25, wt: 0.008, pcsPerPacket: 1000 },
    { id: 'gj-16-l', name: 'GJ-16 L', dims: [3,6.7], price: 25, wt: 0.0089, pcsPerPacket: 1000 },
    { id: 'gj-17', name: 'GJ-17', dims: [3.6,5.7], price: 28, wt: 0.0083, pcsPerPacket: 1000 },
    { id: 'gj-18', name: 'GJ-18', dims: [3.5,6], price: 28, wt: 0.0075, pcsPerPacket: 1000 },
    { id: 'gj-19', name: 'GJ-19', dims: [3.5,4], price: 25, wt: 0.005, pcsPerPacket: 1000 },
    { id: 'gj-20', name: 'GJ-20', dims: [4,4], price: 25, wt: 0.0073, pcsPerPacket: 1000 },
    { id: 'gj-21', name: 'GJ-21', dims: [4,6.4], price: 28, wt: 0.0085, pcsPerPacket: 1000 },
    { id: 'gj-22', name: 'GJ-22', dims: [4,4.3], price: 28, wt: 0.0065, pcsPerPacket: 1000 },
    { id: 'gj-23', name: 'GJ-23', dims: [4,5.2], price: 28, wt: 0.0083, pcsPerPacket: 1000 },
    { id: 'gj-24', name: 'GJ-24', dims: [4,5], price: 28, wt: 0.0082, pcsPerPacket: 1000 },
    { id: 'gj-25', name: 'GJ-25', dims: [4,4.6], price: 28, wt: 0.0073, pcsPerPacket: 1000 },
    { id: 'gj-26', name: 'GJ-26', dims: [4,6.5], price: 28, wt: 0.0098, pcsPerPacket: 1000 },
    { id: 'gj-27', name: 'GJ-27', dims: [5,6], price: 28, wt: 0.009, pcsPerPacket: 1000 },
    { id: 'gj-28', name: 'GJ-28', dims: [4,4], price: 28, wt: 0.0088, pcsPerPacket: 1000 },
    { id: 'gj-29', name: 'GJ-29', dims: [4.5,8.5], price: 30, wt: 0.0159, pcsPerPacket: 1000 },
    { id: 'gj-30-l', name: 'GJ-30 L', dims: [4.5,5.4], price: 28, wt: 0.0099, pcsPerPacket: 1000 },
    { id: 'gj-31-r', name: 'GJ-31 R', dims: [4.4,4.7], price: 28, wt: 0.0066, pcsPerPacket: 1000 },
    { id: 'gj-31-l', name: 'GJ-31 L', dims: [4.4,4.7], price: 28, wt: 0.0065, pcsPerPacket: 1000 },
    { id: 'gj-32-r', name: 'GJ-32 R', dims: [4,6], price: 28, wt: 0.0082, pcsPerPacket: 1000 },
    { id: 'gj-32-l', name: 'GJ-32 L', dims: [4,6], price: 28, wt: 0.0079, pcsPerPacket: 1000 },
    { id: 'gj-33-r', name: 'GJ-33 R', dims: [4,8], price: 28, wt: 0.0112, pcsPerPacket: 1000 },
    { id: 'gj-33-l', name: 'GJ-33 L', dims: [4,8], price: 28, wt: 0.0106, pcsPerPacket: 1000 },
    { id: 'gj-34-r', name: 'GJ-34 R', dims: [4.5,7.3], price: 30, wt: 0.0122, pcsPerPacket: 1000 },
    { id: 'gj-34-l', name: 'GJ-34 L', dims: [4.5,7.3], price: 30, wt: 0.0119, pcsPerPacket: 1000 },
    { id: 'gj-35-r', name: 'GJ-35 R', dims: [4,7], price: 30, wt: 0.0125, pcsPerPacket: 1000 },
    { id: 'gj-35-l', name: 'GJ-35 L', dims: [4,7], price: 30, wt: 0.0123, pcsPerPacket: 1000 },
    { id: 'gj-36', name: 'GJ-36', dims: [5,5], price: 30, wt: 0.0115, pcsPerPacket: 1000 },
    { id: 'gj-37', name: 'GJ-37', dims: [5,4,3], price: 25, wt: 0.0095, pcsPerPacket: 1000 },
    { id: 'gj-38', name: 'GJ-38', dims: [5.2,7.6], price: 28, wt: 0.0146, pcsPerPacket: 1000 },
    { id: 'gj-39', name: 'GJ-39', dims: [5,5], price: 28, wt: 0.0114, pcsPerPacket: 1000 },
    { id: 'gj-40', name: 'GJ-40', dims: [5.4,7], price: 28, wt: 0.14, pcsPerPacket: 1000 },
    { id: 'gj-41', name: 'GJ-41', dims: [5,8], price: 30, wt: 0.177, pcsPerPacket: 1000 },
    { id: 'gj-42', name: 'GJ-42', dims: [5,7.5], price: 30, wt: 0.127, pcsPerPacket: 1000 },
    { id: 'gj-43', name: 'GJ-43', dims: [5,5.5], price: 30, wt: 0.114, pcsPerPacket: 1000 },
    { id: 'gj-44', name: 'GJ-44', dims: [5,7], price: 30, wt: 0.126, pcsPerPacket: 1000 },
    { id: 'gj-45', name: 'GJ-45', dims: [5,6], price: 30, wt: 0.104, pcsPerPacket: 1000 },
    { id: 'gj-46-r', name: 'GJ-46 R', dims: [5,7], price: 30, wt: 0.148, pcsPerPacket: 1000 },
    { id: 'gj-47', name: 'GJ-47', dims: [5,7], price: 30, wt: 0.128, pcsPerPacket: 1000 },
    { id: 'gj-48', name: 'GJ-48', dims: [5,5], price: 30, wt: 0.104, pcsPerPacket: 1000 },
    { id: 'gj-49-r', name: 'GJ-49 R', dims: [5.4,6.7], price: 30, wt: 0.138, pcsPerPacket: 1000 },
    { id: 'gj-49-l', name: 'GJ-49 L', dims: [5.4,6.7], price: 30, wt: 0.142, pcsPerPacket: 1000 },
    { id: 'gj-50-r', name: 'GJ-50 R', dims: [5.5,6.5], price: 30, wt: 0.135, pcsPerPacket: 1000 },
    { id: 'gj-50-l', name: 'GJ-50 L', dims: [5.5,6.5], price: 30, wt: 0.14, pcsPerPacket: 1000 },
    { id: 'gj-51-r', name: 'GJ-51 R', dims: [5.4,6.6], price: 30, wt: 0.155, pcsPerPacket: 1000 },
    { id: 'gj-51-l', name: 'GJ-51 L', dims: [5.4,6.6], price: 30, wt: 0.154, pcsPerPacket: 1000 },
    { id: 'gj-52-r', name: 'GJ-52 R', dims: [5.4,7.5], price: 30, wt: 0.145, pcsPerPacket: 1000 },
    { id: 'gj-52-l', name: 'GJ-52 L', dims: [5.4,7.5], price: 30, wt: 0.141, pcsPerPacket: 1000 },
    { id: 'gj-53-r', name: 'GJ-53 R', dims: [5.3,5.7], price: 30, wt: 0.13, pcsPerPacket: 1000 },
    { id: 'gj-53-l', name: 'GJ-53 L', dims: [5.3,5.7], price: 30, wt: 0.136, pcsPerPacket: 1000 },
    { id: 'gj-54-r', name: 'GJ-54 R', dims: [5,9], price: 35, wt: 0.191, pcsPerPacket: 1000 },
    { id: 'gj-54-l', name: 'GJ-54 L', dims: [5,9], price: 35, wt: 0.184, pcsPerPacket: 1000 },
    { id: 'gj-55-r', name: 'GJ-55 R', dims: [5,7.3], price: 30, wt: 0.131, pcsPerPacket: 1000 },
    { id: 'gj-55-l', name: 'GJ-55 L', dims: [5,7.3], price: 30, wt: 0.134, pcsPerPacket: 1000 },
    { id: 'gj-56-r', name: 'GJ-56 R', dims: [5.8,7], price: 35, wt: 0.146, pcsPerPacket: 1000 },
    { id: 'gj-56-l', name: 'GJ-56 L', dims: [5.8,7], price: 35, wt: 0.14, pcsPerPacket: 1000 },
    { id: 'gj-57-r', name: 'GJ-57 R', dims: [5.7,6.5], price: 30, wt: 0.129, pcsPerPacket: 1000 },
    { id: 'gj-57-l', name: 'GJ-57 L', dims: [5.7,6.5], price: 30, wt: 0.128, pcsPerPacket: 1000 },
    { id: 'gj-58', name: 'GJ-58', dims: [6,7], price: 30, wt: 0.136, pcsPerPacket: 1000 },
    { id: 'gj-59', name: 'GJ-59', dims: [6,7.3], price: 30, wt: 0.185, pcsPerPacket: 1000 },
    { id: 'gj-60', name: 'GJ-60', dims: [6.5,7.5], price: 30, wt: 0.165, pcsPerPacket: 1000 },
    { id: 'gj-61', name: 'GJ-61', dims: [6,8.5], price: 35, wt: 0.172, pcsPerPacket: 1000 },
    { id: 'gj-62-l', name: 'GJ-62 L', dims: [6.5,11], price: 40, wt: 0.278, pcsPerPacket: 1000 },
    { id: 'gj-63', name: 'GJ-63', dims: [6,8.5], price: 35, wt: 0.234, pcsPerPacket: 1000 },
    { id: 'gj-64-l', name: 'GJ-64 L', dims: [6,7], price: 30, wt: 0.193, pcsPerPacket: 1000 },
    { id: 'gj-65', name: 'GJ-65', dims: [6,6], price: 30, wt: 0.146, pcsPerPacket: 1000 },
    { id: 'gj-66', name: 'GJ-66', dims: [6,6], price: 30, wt: 0.169, pcsPerPacket: 1000 },
    { id: 'gj-67-r', name: 'GJ-67 R', dims: [6.3,6.6], price: 30, wt: 0.131, pcsPerPacket: 1000 },
    { id: 'gj-67-l', name: 'GJ-67 L', dims: [6.3,6.6], price: 30, wt: 0.131, pcsPerPacket: 1000 },
    { id: 'gj-68-r', name: 'GJ-68 R', dims: [6.5,10], price: 40, wt: 0.26, pcsPerPacket: 1000 },
    { id: 'gj-68-l', name: 'GJ-68 L', dims: [6.5,10], price: 40, wt: 0.245, pcsPerPacket: 1000 },
    { id: 'gj-69-l', name: 'GJ-69 L', dims: [7,8], price: 35, wt: 0.253, pcsPerPacket: 1000 },
    { id: 'gj-70-r', name: 'GJ-70 R', dims: [8,11.5], price: 45, wt: 0.436, pcsPerPacket: 1000 },
    { id: 'gj-70-l', name: 'GJ-70 L', dims: [8,11.5], price: 45, wt: 0.433, pcsPerPacket: 1000 },
    { id: 'gj-71', name: 'GJ-71', dims: [9,14.5], price: 60, wt: 0.519, pcsPerPacket: 1000 },
    { id: 'gj-72-r', name: 'GJ-72 R', dims: [9,11], price: 50, wt: 0.508, pcsPerPacket: 1000 },
    { id: 'gj-72-l', name: 'GJ-72 L', dims: [9,11], price: 50, wt: 0.519, pcsPerPacket: 1000 },
    { id: 'gj-73-r', name: 'GJ-73 R', dims: [9.3,11], price: 50, wt: 0.495, pcsPerPacket: 1000 },
    { id: 'gj-73-l', name: 'GJ-73 L', dims: [9.3,11], price: 50, wt: 0.487, pcsPerPacket: 1000 },
    { id: 'gj-74-r', name: 'GJ-74 R', dims: [10,11], price: 60, wt: 0.465, pcsPerPacket: 1000 },
    { id: 'gj-74-l', name: 'GJ-74 L', dims: [10,11], price: 60, wt: 4.64, pcsPerPacket: 1000 },
    { id: 'gj-75-r', name: 'GJ-75 R', dims: [9.7,10.3], price: 45, wt: 0.456, pcsPerPacket: 1000 },
    { id: 'gj-75-l', name: 'GJ-75 L', dims: [9.7,10.3], price: 45, wt: 0.465, pcsPerPacket: 1000 },
    { id: 'gj-76-r', name: 'GJ-76 R', dims: [9.7,10], price: 45, wt: 0.427, pcsPerPacket: 1000 },
    { id: 'gj-76-l', name: 'GJ-76 L', dims: [9.7,10], price: 45, wt: 0.422, pcsPerPacket: 1000 },
    { id: 'gj-77-r', name: 'GJ-77 R', dims: [9.5,11], price: 50, wt: 0.498, pcsPerPacket: 1000 },
    { id: 'gj-77-l', name: 'GJ-77 L', dims: [9.5,11], price: 50, wt: 0.5, pcsPerPacket: 1000 },
    { id: 'gj-78-r', name: 'GJ-78 R', dims: [4.7,5.3], price: 30, wt: 0.119, pcsPerPacket: 1000 },
    { id: 'gj-78-l', name: 'GJ-78 L', dims: [4.7,5.3], price: 30, wt: 0.105, pcsPerPacket: 1000 },
  ],
};
