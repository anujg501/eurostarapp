...
const STONES: { id: string; shape: string; size: string }[] = [
  { id: '01', shape: 'Shield', size: '8 × 7' },
  { id: '02', shape: 'Octagon', size: '8 × 8' },
  { id: '03', shape: 'Double Cone', size: '3 × 6' },
  { id: '04', shape: 'Lozenge', size: '7.5 × 3.5' },
  { id: '05', shape: 'Pentagon', size: '6 × 6' },
  { id: '06', shape: 'Pentagon', size: '4.5 × 3' },
  { id: '07', shape: 'Long Drop', size: '10 × 5' },
  { id: '08', shape: 'Hexagon', size: '6.0' },
  { id: '09', shape: 'Fan', size: '7.5 × 6' },
  { id: '10', shape: 'Clover', size: '6 × 6' },
  { id: '11', shape: 'Half Round', size: '5.0' },
  { id: '12', shape: 'Baguette', size: '4 × 8' },
  { id: '13', shape: 'Long Hexagon', size: '7 × 3.5' },
  { id: '14', shape: 'Half Round', size: '5.7 × 5.9' },
  { id: '15', shape: 'Flower', size: '5.0' },
  { id: '16', shape: 'Kite', size: '7.5 × 4' },
  { id: '17', shape: 'Pear', size: '4.5 × 8' },
  { id: '18', shape: 'Half Hex', size: '5 × 2.5' },
  { id: '19', shape: 'Lips', size: '6 × 4' },
  { id: '20', shape: 'Drop Kite', size: '4 × 6' },
  { id: '21', shape: 'Pentagon', size: '5 × 5' },
  { id: '22', shape: 'Kite', size: '3 × 6' },
  { id: '23', shape: 'Hexagon', size: '7 × 4' },
  { id: '24', shape: 'Heart', size: '5 × 4' },
  { id: '25', shape: 'Hexagon', size: '4.0' },
  { id: '26', shape: 'Half Hex', size: '5 × 2.5 B' },
  { id: '27', shape: 'Crescent', size: '8.5 × 3.5' },
  { id: '28', shape: 'Kite', size: '6.5 × 4' },
  { id: '29', shape: 'Half Baguette', size: '6 × 3' },
  { id: '30', shape: 'Pear', size: '3 × 6' },
  { id: '31', shape: 'Drop', size: '5 × 2.5' },
  { id: '32', shape: 'Long Hexagon', size: '7 × 3' },
  { id: '33', shape: 'Heart', size: '4 × 3.5' },
  { id: '34', shape: 'Half Moon', size: '3 × 6' },
  { id: '35', shape: 'Hexagon', size: '5 × 3' },
  { id: '36', shape: 'Pear', size: '4.5 × 3' },
  { id: '37', shape: 'Point Hex', size: '5 × 2' },
  { id: '38', shape: 'Kite', size: '5 × 4' },
  { id: '39', shape: 'Rhomb', size: '5 × 2.5 C' },
];
